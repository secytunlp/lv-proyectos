...
class CheckSelectedRolePermissions
{
    public function handle($request, Closure $next)
    {
        ...
        $permissionMap = [
            ...
            'integrantes.buscarInvestigador' => ['integrante-listar'],
            ...
            'solicitud_sicadis.admitir' => ['solicitud_sicadi-admitir'],
            'solicitud_sicadis.rechazar' => ['solicitud_sicadi-rechazar'],
            'solicitud_sicadis.saveDeny' => ['solicitud_sicadi-rechazar'],
            'solicitud_sicadis.rectificar' => ['solicitud_sicadi-rechazar'],
            'solicitud_sicadis.saveRect' => ['solicitud_sicadi-rechazar'],
            'solicitud_sicadis.exportar' => ['solicitud_sicadi-rechazar'],
            'solicitud_sicadis.migrarFotos' => ['solicitud_sicadi-rechazar'],
