...
class Persona extends Model
{
    ...
    protected $fillable = ['nombre', 'apellido','email','telefono','calle','nro','piso','depto','localidad','cp','observaciones','tipoDocumento','documento','cuil','nacimiento','genero','foto','fallecimiento'];
