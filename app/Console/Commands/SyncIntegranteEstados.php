    ...
    , cyt_integrante_estado.ds_motivos as motivos, cyt_integrante_estado.ds_reduccionHS as reduccion,
       ...
       CASE cyt_integrante_estado.ds_orgbeca
           WHEN 'U.N.L.P' THEN 'UNLP'
                   ...
                   WHEN 'CONSEJO SUPERIOR DE INVESTIGACIONES CIENTIFICAS' THEN 'CONICET'
                   ...
                   WHEN 'FAC. INGENIERÍA UNLP' THEN 'UNLP'
                   WHEN 'UNIVERSIDAD NACIONAL LA PLATA' THEN 'UNLP'
                   ...
                   WHEN 'Beca nivel inicial ANPCyT proyecto PICT2013-0816' THEN 'ANPCyT'
       ...
       CASE cyt_integrante_estado.ds_tipobeca
           WHEN 'POSTGRADO/DOCTORADO' THEN 'Beca doctoral'
                   ...
                   WHEN 'I' THEN 'TIPO I'
                   WHEN 'Beca Tipo I Conicet' THEN 'TIPO I'
                   ...
                   WHEN 'POST-GRADO TIPO I' THEN 'TIPO I'
                   ...
                   WHEN 'Becario Interno Doctoral' THEN 'Beca doctoral'
                   ...
                   WHEN 'POST-DOCTORAL INTERNA' THEN 'Beca posdoctoral'
                    ...
                    DB::connection('mysql')
                        ...
                        ->upsert(
                            ...
                            [
                                ...
                                'institucion','beca','desde','hasta','comentarios','updated_at'
                            ]
                        );
