...
class SyncViajes extends Command
{
    ...
    public function handle()
    {
       ...
       CASE TRIM(solicitud.`ds_orgbeca`)
                   ...
                   WHEN 'FACULTAD CIENCIAS EXACTAS' THEN 'UNLP'
                   ...
                   WHEN 'INTA' THEN 'OTRA'
                   WHEN 'FUNDACIÓN YPF (BECA ESTENSSORO)' THEN 'OTRA'
                   ...
                   WHEN 'UNLP FBA' THEN 'UNLP'
                   WHEN 'U.N.L.P. (POR FACULTAD DE CIENCIAS EXACTAS)' THEN 'UNLP'
                   ...
                   WHEN 'ANPYCT' THEN 'ANPCyT'
                   WHEN 'Agencia Nacional de Promoción de la Investigación, el Desarrollo Tecnológico y la Innovación .' THEN 'ANPCyT'
                   WHEN 'Agencia Nacional' THEN 'ANPCyT'
                   WHEN 'AGENCIA DE PROMOCIÓN CIENTÍFICA Y TECNOLÓGICA (AGENCIA)' THEN 'ANPCyT'
                   WHEN 'Agencia de Promoción Científica y Tecnológica' THEN 'ANPCyT'
                   WHEN 'ANCYPT' THEN 'AGENCIA NACIONAL DE PROMOCIÓN CIENTÍFICA Y   TECNOLÓGICA'
                   WHEN 'AGENCIA NACIONAL PROMOCION CIENTIFICA Y TECNOLOGICA' THEN 'ANPCyT'
                   WHEN 'AGENCIA NACIONAL DE PROMOCION CIENTIFICA Y TECNOLOGICA Y CONICET' THEN 'ANPCyT'
                   WHEN 'UNLP-AGENCIA DE PROMOCIÓN DE CIENCIA Y TECNOLOGÍA (PRH)' THEN 'ANPCyT'
                   WHEN 'FAU-UNLP' THEN 'UNLP'
                   WHEN 'FCE-UNLP' THEN 'UNLP'
                   WHEN 'CEDLAS' THEN 'UNLP'
                   WHEN 'FaHCE-UNLP' THEN 'UNLP'
                   WHEN 'FAHCE - UNLP' THEN 'UNLP'
                   WHEN 'Facultad de Artes' THEN 'UNLP'
                   WHEN 'Facultad de Cs Económicas' THEN 'UNLP'
                   WHEN 'Presidencia de la UNLP' THEN 'UNLP'
                   WHEN 'Facultad de Periodismo y Comunicación Social' THEN 'UNLP'
                   WHEN 'Facultad de Periodismo y Comunicación Social, UNLP' THEN 'UNLP'
                   WHEN 'Facultad de Ciencias Naturales y Museo' THEN 'UNLP'
                   WHEN 'Facultad de Psicología' THEN 'UNLP'
                   WHEN 'Facultad de Ciencias Naturales y Museo, UNLP' THEN 'UNLP'
                   WHEN 'Universidad Nacional de La Plata, Facultad de Humanidades y Ciencias de la Educación' THEN 'UNLP'
                   WHEN 'Universidad Nacional de La Plata (UNLP)' THEN 'UNLP'
                   WHEN 'Facultad de Humanidades y Ciencias de la Educación - UNLP' THEN 'UNLP'
                   WHEN 'U.N.L.P., FACULTAD DE BELLAS ARTES' THEN 'UNLP'
                   ...
                   WHEN 'CENTRO DE INVESTIGACIONES URBANAS Y TERRITORIALES.CIUT-FAU-UNLP' THEN 'UNLP'
                   WHEN 'UNLP-CIN' THEN 'CIN'
                   WHEN 'CONSEJO INTERUNIVERSITARIO NACIONAL' THEN 'CIN'
                   WHEN 'Consejo Interuniversitario Nacional (CIN)' THEN 'CIN'
                   WHEN 'COPNICET' THEN 'CONICET'
                   WHEN 'Centro de Investigaciones Cardiovasculares. CONICET-UNLP' THEN 'CONICET'
                   WHEN 'Comisión de Investigaciones Científicas y Técnicas (CONICET)' THEN 'CONICET'
                   WHEN 'CIC PBA' THEN 'CIC'
                   WHEN 'CIC. PBA' THEN 'CIC'
                   WHEN 'COMISIÓN DE INVEST. CIENTÍFICAS DE LA PROVINCIA DE BS AS' THEN 'CIC'
                   WHEN 'DAAD' THEN 'OTRA'
                   WHEN 'COMISIÓN DE INVESTIGACIONES CIENTÍFICAS (CIC)' THEN 'CIC'
                   WHEN 'CIC - PBA' THEN 'CIC'
                   WHEN 'Comisión de Investigaciones Científicas, Prov. de Bs. As. (CIC-PBA)' THEN 'CIC'
                   WHEN 'COMISION DE INVESTIGACIONES CIENTIFICAS DE LA PCIA DE BUENOS AIRES' THEN 'CIC'
                   WHEN 'COMISIÓN DE INVESTIGACIONES CIENTÍFICAS' THEN 'CIC'
                   WHEN 'Comisión de Investigaciones Científicas de la Pcia de Bs As' THEN 'CIC'
                   ...
                   WHEN 'CONICET-IdIHCS ' THEN 'CONICET'
                   WHEN 'CONICET HASTA EL 01/04/13' THEN 'CONICET'
                   WHEN 'CONSEJO NAC. INVEST. CIENTÍFICAS Y TÉCNICAS (CONICET)' THEN 'CONICET'
                   WHEN 'CONSEJO NACIONAL DE INVESTIACIONES CIENTÍFICAS Y TÉCNICAS' THEN 'CONICET'
                   WHEN 'CONSEJO NACIONAL DE INVESTIGACIONES CIENTIFICAS Y TÉCNICAS (CONICET).' THEN 'CONICET'
                   WHEN 'CONSEJO NACIONA DE INVESTIGACIONES CIENTÍFICAS Y TÉCNICAS (CONICET)' THEN 'CONICET'
                   WHEN 'CONICET-YPF Tecnología S. A.' THEN 'CONICET'
                   ...
                   WHEN 'IFLP' THEN 'CONICET'
                   WHEN 'Consejo Nacional de Investigaciones Científicas y Técnicas CONICET' THEN 'CONICET'
                   WHEN 'CIDCA, CONICET' THEN 'CONICET'
                   WHEN 'Comisión Nacional de Investigaciones Científicas y Técnicas (CONICET)' THEN 'CONICET'
                   WHEN 'III-LIDI' THEN 'CONICET'
                   WHEN 'CETMIC' THEN 'CONICET'
                   WHEN 'Instituto de Fisiología Vegetal' THEN 'CONICET'
                   WHEN 'IFLP-CONICET' THEN 'CONICET'
                   WHEN 'CINDECA' THEN 'CONICET'
                   WHEN 'INIBIOLP' THEN 'CONICET'
                   WHEN 'UNDAV - CONICET' THEN 'CONICET'
                   WHEN 'CICBA' THEN 'CIC'
                   WHEN 'Comision de investigaciones cientificas Pvcia Bs. As. (CICBA)' THEN 'CIC'
                   WHEN 'UNIVERSIDAD POLITECNICA DE CATALUNIA' THEN 'OTRA'
                   WHEN 'INSTITUTO DE ASTROFÍSICA CANARIAS' THEN 'OTRA'
                   WHEN 'INSTITUTO DE BIOTECNOLOGIA Y BIOLOGIA MOLECULAR' THEN 'OTRA'
                   WHEN 'COLCIENCIAS-COLOMBIA' THEN 'OTRA'
                   WHEN 'Centro de investigaciones cardiovasculares' THEN 'CONICET'
                   WHEN 'CONICET (INGEIS-UNLP)' THEN 'CONICET'
                   WHEN 'Consejo Nacional de Investigaciones Científicas y Ténicas' THEN 'CONICET'
                   WHEN 'Instituto de Investigaciones en Humanidades y Cs. Sociales (IdIHCS- UNLP-CONICET)' THEN 'CONICET'
                   WHEN 'Comisión Nacional Salud Investiga. Beca Carrillo-Oñativia 2014.' THEN 'OTRA'
                   ELSE
               ...
               CASE TRIM(solicitud.`ds_tipobeca`)
                   ...
                   WHEN 'Inicial de Doctorado' THEN 'Beca doctoral'
                   WHEN 'Beca inicial de Doctorado' THEN 'Beca doctoral'
                   WHEN 'Beca Interna Doctoral. Temas Estratégicos' THEN 'Beca doctoral'
                   WHEN 'Beca Interna Doctoral. Temas Estratégicos' THEN 'Beca doctoral'
                   WHEN 'Posgrado - Doctorado temas generales' THEN 'Beca doctoral'
                   WHEN 'Doctotal' THEN 'Beca doctoral'
                   WHEN 'De posgrado' THEN 'Beca doctoral'
                   ...
                   WHEN 'Becario Doctoral Interno' THEN 'Beca doctoral'
                   WHEN 'Doctoral Interna Doctoral Cofinanciada' THEN 'Beca doctoral'
                   WHEN 'doctoral interna' THEN 'Beca doctoral'
                   WHEN 'Primer año' THEN 'Beca doctoral'
                   WHEN 'Beca Interna Doctoral (2° año)' THEN 'Beca doctoral'
                   ...
                   WHEN 'Completa' THEN 'Beca doctoral'
                   WHEN 'Interna Doctoral' THEN 'Beca doctoral'
                   WHEN 'DOCTORAL FORMACIÓN' THEN 'Beca doctoral'
                   WHEN 'En abril 2020 comienza el 4to año de beca' THEN 'Beca doctoral'
                   ...
                   WHEN 'Doctoral por temas estratégicos' THEN 'Beca doctoral'
                   WHEN 'Planes Estratégicos 2013' THEN 'Beca doctoral'
                   ...
                   WHEN 'Postoctoral' THEN 'Beca posdoctoral'
                   WHEN 'POST-DOCTORAL DE REINSERCION' THEN 'Beca posdoctoral'
                   WHEN 'POSTDOCTORAL INTERNA (2 AÑOS)' THEN 'Beca posdoctoral'
                   WHEN 'Postdoctoral Conicet' THEN 'Beca posdoctoral'
                   WHEN 'Becaria Posdoctoral' THEN 'Beca posdoctoral'
                   WHEN 'Beca Interna Postdoctoral Temas Estratégicos' THEN 'Beca posdoctoral'
                   WHEN 'Avanzado' THEN 'Beca posdoctoral'
                   WHEN 'BECA INTERNA POSDOCTORAL CONICET' THEN 'Beca posdoctoral'
                   WHEN 'Postdoctoral, Categorizacion V de investigador' THEN 'Beca posdoctoral'
                   WHEN 'Posdoctoral extraordinaria' THEN 'Beca posdoctoral'
                   WHEN 'Posdoctoral en Temas Estratégicos' THEN 'Beca posdoctoral'
                   WHEN 'opstdoctoral' THEN 'Beca posdoctoral'
                   WHEN 'POSDOCTORAL (CON PRÓRROGA)' THEN 'Beca posdoctoral'
                   WHEN 'Posdoctoral Interna' THEN 'Beca posdoctoral'
                   WHEN 'Postdoctorado (hasta Alta Ingreso CIC)' THEN 'Beca posdoctoral'
                   WHEN 'Postodctoral' THEN 'Beca posdoctoral'
                   WHEN 'POST- DOCTORAL' THEN 'Beca posdoctoral'
                   WHEN 'POSDOCTOTAL' THEN 'Beca posdoctoral'
                   WHEN 'POSDOC' THEN 'Beca posdoctoral'
                   WHEN 'POSDOOCTORAL' THEN 'Beca posdoctoral'
                   WHEN 'POSDOCTORAL DE REINSERCIÓN' THEN 'Beca posdoctoral'
                   ...
                   WHEN 'Doctorando Tipo II' THEN 'TIPO II'
                   WHEN 'BECA II' THEN 'TIPO II'
                   WHEN 'Tipo II - de Posgrado' THEN 'TIPO II'
                   WHEN 'TIPO II Y A SU FINALIZACIÓN POSTDOCTORAL' THEN 'TIPO II'
                   WHEN 'BECARIO TIPO 2' THEN 'TIPO II'
                   WHEN 'TIPO II (CON POST DOCTORAL OTORGADA A PARTIR DEL 01/04/2014)' THEN 'TIPO II'
                   WHEN 'POSTGRADO TIPO I Y POSTGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'POSGRADO TIPO I +POSGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'INTERNA DE POS GRADO TIPO II' THEN 'TIPO II'
                   WHEN 'PERFECCIONAMIENTO (POSGRADO TIPO II)' THEN 'TIPO II'
                   WHEN 'POST GRADO TIPO II' THEN 'TIPO II'
                   ...
                   WHEN 'Beca Tipo B' THEN 'TIPO B'
                   WHEN 'Beca tipo B' THEN 'TIPO B'
                   WHEN 'Beca Tipo B, Prorrogada.' THEN 'TIPO B'
                   WHEN 'Doctorado (tipo b)' THEN 'TIPO B'
                   WHEN 'B DE UNLP' THEN 'TIPO B'
                   WHEN 'POST-DOCTORADO' THEN 'Beca posdoctoral'
                   WHEN 'II' THEN 'TIPO II'
                   WHEN 'BECA DE POSTGRADO DE TIPO II' THEN 'TIPO II'
                   WHEN 'POSGRADO TIPO I Y TIPO II' THEN 'TIPO II'
                   WHEN 'POSGRADO TIPO  II' THEN 'TIPO II'
                   WHEN 'POST GRADO TIPO 2' THEN 'TIPO II'
                   WHEN 'BECA DE POSGRADO INTERNA TIPO II' THEN 'TIPO II'
                   WHEN 'I' THEN 'TIPO I'
                   WHEN 'POST GRADO TIPO 1' THEN 'TIPO I'
                   WHEN 'ECA DE POSGRADO TIPO I' THEN 'TIPO I'
                   WHEN 'BECA INTERNA DE POSGRADO TIPO I.' THEN 'TIPO I'
                   WHEN 'TIPO I DOCTORAL' THEN 'TIPO I'
                   WHEN 'POSTGRADO INTERNA TIPO I' THEN 'TIPO I'
                   WHEN 'PG I' THEN 'TIPO I'
                   ...
                   WHEN 'BECA DE POSGRADUADOS' THEN 'Beca posdoctoral'
                   WHEN 'BECA DOCTORAL TIPO II' THEN 'TIPO II'
                   WHEN 'PERFECCIONAMIENTO' THEN 'BECA DE PERFECCIONAMIENTO'
                   WHEN 'Beca de Perfeccionamiento en Salud Pública.' THEN 'BECA DE PERFECCIONAMIENTO'
                   WHEN 'BECARIO DE PERFECCIONAMIENTO' THEN 'BECA DE PERFECCIONAMIENTO'
                   WHEN 'Beca de perfeccionamiento (Doctoral 3er año)' THEN 'BECA DE PERFECCIONAMIENTO'
                   WHEN 'DOCTORAL' THEN 'Beca doctoral'
                   WHEN 'POSTGRADO' THEN 'Beca doctoral'
                   WHEN 'POSTGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'TIPO III' THEN 'TIPO II'
                   ...
                   WHEN 'DE POSTGRADO TIPO II (DOCTORAL)' THEN 'TIPO II'
                   ...
                   WHEN '2' THEN 'TIPO II'
                   WHEN 'DOCTORAL TIPO I' THEN 'TIPO I'
                   WHEN 'DOCTORADO, TIPO I' THEN 'TIPO I'
                   WHEN 'BECA POSTGRADO' THEN 'TIPO I'
                   WHEN 'TIPO I (DEL 1-04-2010 AL 31-03-2013). TIPO II (DEL 1-04-2013 AL 31-03-2015)' THEN 'TIPO II'
                   WHEN 'POST-DOCTORAL' THEN 'Beca posdoctoral'
                   WHEN 'POSDOCTORAL TEMAS ESTRATÈGICOS' THEN 'Beca posdoctoral'
                   WHEN 'Beca de doctorado - Beca de Postdoc - CONICET' THEN 'Beca posdoctoral'
                   WHEN 'BECA DE POSGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'CATEGORÍA II' THEN 'TIPO II'
                   WHEN 'I' THEN 'TIPO I'
                   WHEN 'BECA INTERNA POSTGRADO TIPO 1' THEN 'TIPO I'
                   ...
                   WHEN 'Investigación Superior' THEN 'Formación Superior'
                   WHEN 'FORMACIóN SUPERIOR' THEN 'Formación Superior'
                   WHEN 'SUPERIOR' THEN 'Formación Superior'
                   WHEN 'BECA DE RETENCIÓN DE POSGRADUADO' THEN 'RETENCION DE POSTGRADUADO'
                   WHEN 'Programa de retención de Doctores- UNLP' THEN 'RETENCION DE POSTGRADUADO'
                   ...
                   WHEN 'RETENCIÓN DE POSTGRADUADOS EN EL MARCO DEL PROGRAMA DE RETENCIÓN DE RECURSOS HUMANOS -UNLP' THEN 'RETENCION DE POSTGRADUADO'
                   WHEN 'RETENCION DE RRHH FORMADOS' THEN 'RETENCION DE POSTGRADUADO'
                   ...
                   WHEN 'Postdoctoral del Programa de Retención de Doctores de la UNLP' THEN 'RETENCION DE POSTGRADUADO'
                   WHEN 'BECA INTERNA DE POSGRADO' THEN 'Beca doctoral'
                   WHEN 'Doctorado en Ingenieria' THEN 'Beca doctoral'
                   WHEN 'UNLP DOCTORADO' THEN 'Beca doctoral'
                   ...
                   WHEN 'Programa de Retención de Doctores de la UNLP (Resol.-4295-19)' THEN 'RETENCION DE POSTGRADUADO'
                   ...
                   WHEN 'INICIAL  ANPCYT, TIPO II CONICET' THEN 'Beca inicial'
                   ...
                   WHEN 'BECA INTERNA POSGRADO II' THEN 'TIPO II'
                   WHEN 'BECA DE POSGRADO TIPO A' THEN 'TIPO A'
                   WHEN 'POSGRADO TIPO I' THEN 'TIPO I'
                   WHEN 'BECA DE POSGRADO TIPO I' THEN 'TIPO I'
                   WHEN 'Beca de Posgrado' THEN 'TIPO I'
                   ...
                   WHEN 'Beca de estudio (2013-2015) y Beca de perfeccionamiento (2015-2016)' THEN 'BECA DE PERFECCIONAMIENTO'
                   ...
                   WHEN 'BECARIO CONICET TIPO II' THEN 'TIPO II'
                   WHEN 'BECA DE POSTGRADO TIPO II - CONICET' THEN 'TIPO II'
                   WHEN 'INTERNA DE POSGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'BECA INTERNA DE POSGRADO TIPO I' THEN 'TIPO I'
                   ...
                   WHEN 'TIPO A (INICIACION)' THEN 'TIPO A'
                   WHEN 'TIPO A (2° AÑO)' THEN 'TIPO A'
                   ...
                   WHEN 'de finalización del doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'Tipo II - Finalización de doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'beca tipo II  -Finalización de doctotado' THEN 'Beca finalización del doctorado'
                   WHEN 'Tipo II - Finalización de doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'Beca Finalización de doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'Beca de finalización de doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'Beca de Finalización del Doctorado' THEN 'Beca finalización del doctorado'
                   WHEN 'Finalizando' THEN 'Beca finalización del doctorado'
                   WHEN 'INTERNA FIN DE DE DOCTORADO' THEN 'Beca finalización del doctorado'
                   WHEN 'POSGRADO-DOCTORAL' THEN 'Beca doctoral'
                   WHEN 'Posgrado- Beca Interna Doctoral' THEN 'Beca doctoral'
                   ...
                   WHEN 'Perfeccionamiento (doctoral)' THEN 'BECA DE PERFECCIONAMIENTO'
                   ...
                   WHEN '3º AÑO' THEN 'TIPO I'
                   WHEN '3 año' THEN 'TIPO I'
                   WHEN 'Cuarto año' THEN 'TIPO I'
                   WHEN 'BECA INTERNA DE POSTGRADO TIPO I (ASPIRANTE)' THEN 'TIPO I'
                   WHEN 'INICIACIÓN TIPO I' THEN 'TIPO I'
                   WHEN 'pos-grado' THEN 'TIPO I'
                   WHEN 'INTERNA DE POSTGRADO TIPO II' THEN 'TIPO II'
                   WHEN 'beca doctoral tipo II / beca posdoctoral' THEN 'TIPO II'
                   ...
                   WHEN 'Becaria Postdoctoral' THEN 'Beca posdoctoral'
                   ...
                   WHEN 'POSGRADO TIPO I (3 AÑOS)' THEN 'TIPO I'
                   ...
                   WHEN 'Beca interna doctoral en temas estratégicos' THEN 'Beca doctoral'
                   ...
                   WHEN 'Posdoctoral PUE' THEN 'Beca posdoctoral'
                   WHEN 'Beca Inicial FONCyT' THEN 'Beca inicial'
                   ...
                   WHEN 'Beca de Posdoctorado' THEN 'Beca posdoctoral'
                   ...
                   WHEN 'Doctoral - Posdoctoral' THEN 'Beca posdoctoral'
                   WHEN 'POSTGRADO/DOCTORADO BECA TIPO B' THEN 'TIPO B'
