...
class SyncViajeAmbitos extends Command
{
    protected $signature = 'sync:viajeambitos';
    ...
    public function handle()
    {
        ...
        DB::connection('mysql_origen')
                    ...
                    ->selectRaw("ambito.cd_ambito as id, ambito.cd_solicitud as viaje_id, ambito.dt_desde as desde,
    ambito.dt_hasta as hasta, ambito.ds_institucion as institucion, ambito.ds_ciudad as ciudad, ambito.ds_pais as pais")

            ->orderBy('ambito.cd_ambito')
                ...
                if (!empty($data)) {
                    ...
                    DB::connection('mysql')
                        ...
                        ->upsert(
                            ...
                            ['id'], // clave única
                            [
                                'viaje_id','ciudad','desde','hasta','institucion','pais','updated_at'
                            ]
                        );
