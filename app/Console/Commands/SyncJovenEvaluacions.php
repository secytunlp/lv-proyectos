...
class SyncJovenEvaluacions extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync:jovenevaluacions';
    ...
    public function handle()
    {
        ...
        DB::connection('mysql_origen')
            ->table('evaluacionjovenes')
            ->leftJoin('cyt_user', 'evaluacionjovenes.cd_usuario', '=', 'cyt_user.oid')
            ->leftJoin('cyt_evaluacionjovenes_estado', 'evaluacionjovenes.cd_evaluacion', '=', 'cyt_evaluacionjovenes_estado.evaluacion_oid')

            ->selectRaw("evaluacionjovenes.cd_evaluacion as id,evaluacionjovenes.cd_solicitud as joven_id,
...
END as estado,
       ...
       evaluacionjovenes.dt_fecha as fecha, evaluacionjovenes.nu_puntaje as puntaje, CAST(evaluacionjovenes.bl_interno AS UNSIGNED) as interno, evaluacionjovenes.ds_observacion as observaciones")
        ->whereNull('cyt_evaluacionjovenes_estado.fechaHasta')
            ->orderBy('evaluacionjovenes.cd_evaluacion')
                ...
                try {
                    ...
                    DB::connection('mysql')
                        ...
                        ->upsert(
                            ...
                            ['id'],
                            [
                                'joven_id','user_id','user_name','user_cuil','estado',
