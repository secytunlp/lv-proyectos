...
class SyncJovenProyectoActuales extends Command
{
    protected $signature = 'sync:jovenproyectoactuales';
    ...
    solicitudjovenesproyecto.ds_titulo as titulo, solicitudjovenesproyecto.bl_agregado as agregado")
            ->whereRaw("periodo.ds_periodo BETWEEN YEAR(solicitudjovenesproyecto.dt_desde)
                        AND IFNULL(YEAR(solicitudjovenesproyecto.dt_hasta), YEAR(solicitudjovenesproyecto.dt_desde))")
