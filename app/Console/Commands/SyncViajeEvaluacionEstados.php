...
class SyncViajeEvaluacionEstados extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'sync:viajeevaluacionestados';
    ...
    public function handle()
    {
       ...
       cyt_evaluacion_estado.fechaDesde as desde, cyt_evaluacion_estado.fechaHasta as hasta, cyt_evaluacion_estado.motivo as comentarios
")
            ->orderBy('cyt_evaluacion_estado.oid')
            ->chunk(1000, function ($rows) use (&$totalFilas, &$totalInsertadas, &$totalOmitidas, &$skippedRows){
                ...
                try {
                    ...
                    DB::connection('mysql')
                        ->table('viaje_evaluacion_estados')
                        ->upsert(
                            $data,
                            ['id'],
                            [
                                'viaje_evaluacion_id','user_id','user_name','estado',
