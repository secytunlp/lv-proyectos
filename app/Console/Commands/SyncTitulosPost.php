...
class SyncTitulosPost extends Command
{
    protected $signature = 'sync:titulospost';
    ...
    public function handle()
    {
        ...
        $rows = DB::connection('mysql_origen')
            ...
            ->select([
                ...
                'cd_titulopost as titulo_id'
            ])
            ->whereNotNull('cd_titulopost')
            ->where('cd_titulopost', '!=', '9999')
            ->where('cd_titulopost', '!=', 0) // extra defensivo
            ->get();
        ...
        DB::connection('mysql')
            ->table('investigador_tituloposts')
            ->upsert(
                $data,
