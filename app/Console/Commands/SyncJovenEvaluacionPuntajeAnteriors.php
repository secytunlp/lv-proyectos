...
class SyncJovenEvaluacionPuntajeAnteriors extends Command
{
    /**
    ...
    public function handle()
    {
        ...
        DB::connection('mysql_origen')
            ->table('puntajesubanterior')



            ->selectRaw("`cd_puntajesubanterior` as id,`cd_evaluacion` as joven_evaluacion_id,`cd_modeloplanilla` as joven_evaluacion_planilla_id,`cd_subanteriormaximo` as joven_evaluacion_planilla_anterior_max_id,`nu_puntaje` as puntaje
")
            ->orderBy('puntajesubanterior.cd_puntajesubanterior')
