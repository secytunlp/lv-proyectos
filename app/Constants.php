...
class Constants
{
    ...
    const CARRERAS_INVESTIGACION = '1,2,3,6,8,9,10,12';
    ...
    const SICADI_ACTUAL = '4';

    const CIERRE_SICADI = '2025-12-01';

    const YEAR_SICADI = '2025';

    const MAIL_SICADI = 'categorizacion1@presi.unlp.edu.ar';
