...
class CreateJovenEvaluacionPlanillaAntAcadMaxsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('joven_evaluacion_planilla_ant_acad_maxs', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('joven_evaluacion_ant_acad_id')->nullable();
            $table->foreign('joven_evaluacion_ant_acad_id')->references('id')->on('joven_evaluacion_ant_acads');
    ...
    {
        Schema::dropIfExists('joven_evaluacion_planilla_ant_acad_maxs');
    }
}
