...
class CreateInvestigadorTitulopostsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('investigador_tituloposts', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('investigador_tituloposts');
    }
}
