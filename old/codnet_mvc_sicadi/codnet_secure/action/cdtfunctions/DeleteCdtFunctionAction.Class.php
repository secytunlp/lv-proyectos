...
/**
 * Acción para eliminar CdtFunction.
 * 
 * @author codnet archetype builder
 * @since 29-12-2011
 * 
 */
class DeleteCdtFunctionAction extends CdtEditAction {
	...
	protected function edit( $oEntity ){
		...
		$manager->deleteCdtFunction( $oEntity );
	}
	...
	protected function getForwardSuccess(){
		...
		return 'delete_cdtfunction_success';
	}
	...
	protected function getForwardError(){
		$_GET["search"] = 1;
		return 'delete_cdtfunction_error';
	}
