...
class CdtPaginator {
	...
	protected $num_pages; //Cantidad de P�ginas que surgen de la consulta que se quiere paginar
	...
	protected $css_class_actual_page; //Clase de estilo CSS para aplicar al numero que indica la p�gina actual
	...
	/**
	 * le agregamos la page como par�metro as� se puede
