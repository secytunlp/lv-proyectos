...
class sql_db
{
	...
	function sql_query($query = "", $transaction = FALSE)
	{
		...
		//La declaramos por problemas de usar una variable sin declaracion previa
		$query_aux=$query;
		$row_offset=''; 
		...
		if ( $query != "" )
		{
			...
			{	
				if( $query_result=mssql_query($query, $this->db_connect_id) )
				{
				...
				{
					//Linea agregada para Escribir la consulta en caso de ERROR
					echo "<br>Error en la consulta: ".$query_aux."<br>";
				}
			}
