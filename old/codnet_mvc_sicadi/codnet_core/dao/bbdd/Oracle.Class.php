...
//FIXME ver esta clase en caso de necesitar ORACLE.
//revisar el tema de las transacciones.

class Oracle implements ICdtDatabase{
	...
	// Base query method
	//
	//function sql_query($query = "", $transaction = FALSE)lo saque para que implente la interface ICdtDatabase
	...
	function begin_tran(){
		...
		//TODO analizar el caso. (cuando se ejecuta un query debe pasarse el mode= OCI_DEFAULT
		//cuanto no hay transacción mode debe ser OCI_COMMIT_ON_SUCCESS.
		return true;	
	}
