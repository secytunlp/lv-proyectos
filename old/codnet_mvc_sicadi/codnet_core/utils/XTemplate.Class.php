...
class XTemplate {
	...
	*/
	...
	/**
	 * retorna true si existe el block
	 * @param unknown_type $bname
	 */
	public function existsBlock( $bname ){

		return isset( $this->preparsed_blocks[$bname] ) || 
		       isset( $this->blocks[$bname] ) ;
