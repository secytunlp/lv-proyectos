	...
	protected function write($string) {
		...
		if(flock($this->fp, LOCK_EX)) {
			...
			if (is_string($string)) {
				...
				// Manejar el caso en el que $string no es una cadena (puedes omitir fwrite() o realizar alguna acción de manejo de errores)
			}
			...
			try {
				if (file_exists($this->file) && is_readable($this->file)) {
					...
					//$this->warn("File does not exist or is not readable. Closing appender.");
					$this->closed = true;
				}
