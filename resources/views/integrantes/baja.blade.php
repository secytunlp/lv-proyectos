            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('integrantes.remove',$integrante->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            {{Form::label('consecuencias', 'Explicar las consecuencias de la baja en el desenvolvimiento del proyecto')}}
                                            {{Form::textarea('consecuencias', '', ['class' => 'form-control'])}}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            {{Form::label('motivos', 'Explicar los motivos de la baja')}}
                                            {{Form::textarea('motivos', '', ['class' => 'form-control'])}}
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            {{Form::label('considerando', 'Considerando la baja, indicar si el el proyecto cumple con los siguientes requisitos')}}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endphp
                                            {{Form::label('minint', $mininteLabel)}}
                                            {{Form::checkbox('minint', 1, false)}}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            @endphp
                                            {{Form::label('minded', $mindedLabel)}}
                                            {{Form::checkbox('minded', 1, false)}}
