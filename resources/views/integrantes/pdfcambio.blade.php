...
<html>
<head>
    <title>Cambio de colaborador</title>
    <style>
...
<div class="content">
    <div class="content" style="margin-top: 10px;">
        <span style="display: inline-block;width: 200px;"><strong>Horas dedicadas al proyecto</strong></span> <span style="display: inline-block; border: 1px solid #ccc;width: 30px; padding-top: {{ $horas ? '0' : '15px' }}">{{$horas}}</span> <span style="display: inline-block;width: 60px;"></span><span style="display: inline-block;width: 15px;"></span><span style="display: inline-block;width: 150px;"><strong>Tipo de Investigador</strong></span> <span style="display: inline-block; border: 1px solid #ccc;width: 230px; padding-top: {{ $tipo_investigador ? '0' : '15px' }}">{{ $tipo_investigador }}</span>
    </div>
</div>
