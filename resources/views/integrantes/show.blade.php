            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('integrantes.update',$integrante->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('PUT') }}
                            <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::number('horas', $integrante->horas, ['class' => 'form-control','placeholder'=>'Horas','disabled'])}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{Form::date('alta', ($integrante->alta)?date('Y-m-d', strtotime($integrante->alta)):'', ['class' => 'form-control','disabled'])}}
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    {{Form::label('baja', 'Fecha de baja')}}
                                                    {{Form::date('baja', ($integrante->baja)?date('Y-m-d', strtotime($integrante->baja)):'', ['class' => 'form-control','disabled'])}}
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('estado', $integrante->estado, ['class' => 'form-control','disabled'])}}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                {{Form::date('nacimiento', ($integrante->nacimiento)?date('Y-m-d', strtotime($integrante->nacimiento)):'', ['class' => 'form-control','disabled'])}}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('facultad_id',  $facultades,$integrante->facultad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'facultad_id','disabled'])}}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('universidad_id',  $universidades,$integrante->universidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'universidad_id','disabled'])}}
                                        ...
                                        <fieldset style="border: 1px solid #ccc; padding: 10px;">
                                            ...
                                            <table class="table" style="width: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ Form::select('titulos[]',$titulos, $integrante->titulo_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled']) }}</td>
                                                    <td>{{Form::date('egresos[]', ($integrante->egresogrado)?date('Y-m-d', strtotime($integrante->egresogrado)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('carrera', $integrante->carrera, ['class' => 'form-control','placeholder'=>'Carrera','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('total', 'Total De Materias')}}
                                                    {{Form::number('total', $integrante->total, ['class' => 'form-control','placeholder'=>'Total De Materias','disabled'])}}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::number('materias', $integrante->materias, ['class' => 'form-control','placeholder'=>'Aprobadas','disabled'])}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('tituloposts[]',$tituloposts, $integrante->titulopost_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled']) }}</td>
                                                        <td>{{Form::date('egresoposts[]', ($integrante->egresoposgrado)?date('Y-m-d', strtotime($integrante->egresoposgrado)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('cargos[]',$cargos, $integrante->cargo_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                        <td>{{ Form::select('deddocs[]',[''=>'','Exclusiva'=>'Exclusiva','Semi Exclusiva'=>'Semi Exclusiva','Simple'=>'Simple'], $integrante->deddoc,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                                        <td>{{Form::date('ingresos[]', ($integrante->alta_cargo)?date('Y-m-d', strtotime($integrante->alta_cargo)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('unidad_id',  $unidads,$integrante->unidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'unidad_id','disabled'])}}
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('carrerainvs[]',$carrerainvs, $integrante->carrerainv_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                        <td>{{ Form::select('organismos[]',$organismos, $integrante->organismo_id,['class' => 'form-control', 'style' => 'width: 150px','disabled']) }}</td>
                                                        <td>{{Form::date('carringresos[]', ($integrante->ingreso_carrera)?date('Y-m-d', strtotime($integrante->ingreso_carrera)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('categorias[]',$categorias, $integrante->categoria_id,['class' => 'form-control', 'style' => 'width: 60px','disabled']) }}</td>
                                                ...
                                                <table class="table" style="width: 50%">
                                                  ...
                                                  <th>Actual</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('sicadis[]',$sicadis, $integrante->sicadi_id,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('institucions[]',[''=>'','ANPCyT'=>'ANPCyT','CIC'=>'CIC','CONICET'=>'CONICET','UNLP'=>'UNLP','CIN'=>'CIN','OTRA'=>'OTRA'], $integrante->institucion,['class' => 'form-control institucion_select', 'style' => 'width: 150px','disabled']) }}</td>
                                                        <td>{{ Form::select('becas[]',\App\Helpers\BecaHelper::obtenerOpcionesBecaPorInstitucion($integrante->institucion), $integrante->beca,['class' => 'form-control beca_select', 'style' => 'width: 150px','disabled']) }}</td>

                                                        <td>{{Form::date('becadesdes[]', ($integrante->alta_beca)?date('Y-m-d', strtotime($integrante->alta_beca)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>

                                                        <td>{{Form::date('becahastas[]',  ($integrante->baja_beca)?date('Y-m-d', strtotime($integrante->baja_beca)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
