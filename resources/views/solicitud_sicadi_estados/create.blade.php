    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('solicitud_sicadi_estados.index') }}">Estados</a></li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados @if($solicitud_sicadi) - {{ $solicitud_sicadi->apellido }}, {{ $solicitud_sicadi->nombre }} en la solicitud {{ $solicitud_sicadi->convocatoria->nombre }} {{ $solicitud_sicadi->convocatoria->tipo }} {{ $solicitud_sicadi->convocatoria->year }}@endif</h3>
                        </div>


                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('solicitud_sicadi_estados.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <!-- Nav tabs -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <input type="hidden" name="solicitud_sicadi_id" value="{{ $solicitud_sicadi->id ?? '' }}">
                                                    {{Form::label('convocatoria', 'Convocatoria')}}
                                                    {{Form::text('convocatoria', $solicitud_sicadi->convocatoria->nombre.' '.$solicitud_sicadi->convocatoria->tipo.' '.$solicitud_sicadi->convocatoria->year, ['class' => 'form-control','placeholder'=>'Convocatoria','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('solicitud_sicadi_estados.index') }}?solicitud_sicadi_id={{ $solicitud_sicadi->id }}" class="btn btn-warning">Volver</a>
