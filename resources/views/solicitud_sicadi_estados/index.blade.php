                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            @if($solicitud_sicadi)<a class='pull-right btn btn-success' href="{{ route('solicitud_sicadi_estados.create', ['solicitud_sicadi_id' => $solicitud_sicadi->id]) }}">Cambiar</a>@endif
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('solicitud_sicadi_estados.dataTable') }}",
                    "type": "POST",
                    "data": function (d) {
                        d._token = '{{ csrf_token() }}'; // Agrega el token CSRF si estás usando Laravel
                        d.solicitud_sicadi_id = '{{ $solicitud_sicadi ? $solicitud_sicadi->id : '' }}'; // Enviar el ID del solicitud_sicadi como filtro
