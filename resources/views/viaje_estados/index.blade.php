                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados @if($viaje) - {{ $viaje->investigador->persona->apellido }} {{ $viaje->investigador->persona->nombre }} en la solicitud {{ $viaje->periodo->nombre }}@endif</h3>
                            @if($viaje)<a class='pull-right btn btn-success' href="{{ route('viaje_estados.create', ['viaje_id' => $viaje->id]) }}">Cambiar</a>@endif
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('viaje_estados.dataTable') }}",
                    "type": "POST",
                    "data": function (d) {
