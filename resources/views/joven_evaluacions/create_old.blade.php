...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-th-list" aria-hidden="true"></i>Evaluación Jóvenes Investigadores
                <small>Asignar Evaluador</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('joven_evaluacions.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <!-- Nav tabs -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    {{Form::label('evaluador', 'Evaluador')}}
                                                    {{Form::select('evaluador_id',  $evaluadores,'', ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'evaluador_id'])}}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-check">
                                                        {{ Form::checkbox('interno', 1, false, ['class' => 'form-check-input']) }}
                                                        <label class="form-check-label" for="interno"></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('joven_evaluacions.index') }}?joven_id={{ $joven->id }}" class="btn btn-warning">Volver</a>
