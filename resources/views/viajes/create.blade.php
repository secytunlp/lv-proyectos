...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-plane" aria-hidden="true"></i>Viajes
                <small>Crear</small>
            </h1>
            <ol class="breadcrumb">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{ Form::text('periodobeca',
                                                                                ($beca) ?
                                                                                    (($beca->desde ? date('Y-m-d', strtotime($beca->desde)) : '') .
                                                                                    ($beca->hasta ? ' - ' . date('Y-m-d', strtotime($beca->hasta)) : ''))
                                                                                    : '',
                                                            ...
                                                            <td>{{Form::checkbox('unlp', 1,($beca) ?(($beca->unlp)?true:false):false)}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('motivo_id',  [''=>'Seleccionar...','A) Reuniones Científicas:'=>'A) Reuniones Científicas:','B) Estadía de trabajo para investigar en ámbitos académicos externos a la UNLP:'=>'B) Estadía de trabajo para investigar en ámbitos académicos externos a la UNLP:','C) ESTADÍA DE TRABAJO EN LA UNLP PARA UN INVESTIGADOR INVITADO:'=>'C) ESTADÍA DE TRABAJO EN LA UNLP PARA UN INVESTIGADOR INVITADO:'],'', ['class' => 'form-control', 'style' => 'width: 100%','id'=>'motivo_id'])}}
                                        ...
                                        <div id="divC" style="display: none">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="form-group">
                                                        {{Form::label('generalC', '1. Objetivo de investigación de la estadía')}}
                                                        {{Form::textarea('generalC', '', ['class' => 'form-control', 'rows' => 4])}}
