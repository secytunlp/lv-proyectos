...
@endif
<div class="content">
    <span style="display: inline-block; border: 1px solid #ccc;width: 695px; padding-top: {{ $justificacion ? '0' : '15px' }}; background-color: #e1e1e1; white-space: pre-wrap;">{!! nl2br(e( $justificacion)) !!}</span>
</div>
@else
    <div class="content">
        <div>Breve descripción de las actividades de I/D que plantea en el marco del proyecto en que se desempeña el solicitante</div>
