                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados @if($joven) - {{ $joven->investigador->persona->apellido }} {{ $joven->investigador->persona->nombre }} en la solicitud {{ $joven->periodo->nombre }}@endif</h3>
                            @if($joven)<a class='pull-right btn btn-success' href="{{ route('joven_estados.create', ['joven_id' => $joven->id]) }}">Cambiar</a>@endif
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "{{ route('joven_estados.dataTable') }}",
                    "type": "POST",
                    "data": function (d) {
