    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('unidad_estados.index') }}">Estados</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados de @if($unidad) - {{ $unidad->denominacion }} {{ $unidad->sigla}}@endif</h3>
                            @if($unidad)<a class='pull-right btn btn-success' href="{{ route('unidad_estados.create', ['unidad_id' => $unidad->id]) }}">Cambiar</a>@endif
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                scrollX: true,
                paging : true,
                "order": [[ 4, "desc" ]], // Ordenar por el tercer campo (apellido) de forma ascendente
                "ajax": {
                    "url": "{{ route('unidad_estados.dataTable') }}",
                    "type": "POST",
                    "data": function (d) {
