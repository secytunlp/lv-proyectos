            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('unidad_estados.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <!-- Nav tabs -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('unidad_estados.index') }}?unidad_id={{ $unidad->id }}" class="btn btn-warning">Volver</a>
