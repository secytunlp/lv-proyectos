                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="datos_personales">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                {{ Form::select('genero',['' => 'Seleccionar...'] + config('generos'), '',['class' => 'form-control','id'=>'genero']) }}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('dpto', $investigador->persona->depto ?? '', ['class' => 'form-control','placeholder'=>'Depto.'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    {{Form::label('cp', 'CP')}}
                                                    {{Form::text('cp', $investigador->persona->cp ?? '', ['class' => 'form-control','placeholder'=>'CP'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                {{Form::text('email_institucional', $investigador->persona->email ?? '', ['class' => 'form-control','placeholder'=>'Email institucional'])}}
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                {{Form::label('email_alternativo', 'Email alternativo')}}
                                                {{Form::text('email_alternativo', '', ['class' => 'form-control','placeholder'=>'Email alternativo'])}}
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('tipo_posgrado',['' => 'Seleccionar...'] + config('tipoPosgrados'), '',['class' => 'form-control','id'=>'tipo_posgrado']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('cargo_docente',['' => 'Seleccionar...'] + config('cargos'), $cargo ?? '',['class' => 'form-control','id'=>'cargo_docente']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('cargo_dedicacion',['' => 'Seleccionar...'] + config('dedicaciones'), $dedicacion ?? '',['class' => 'form-control','id'=>'cargo_dedicacion']) }}
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('cargo_ua',['' => 'Seleccionar...'] + config('facultades'), $cargo_ua ?? '',['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'cargo_ua']) }}
                                                    ...
                                                    <select id="investigacion_ui" class="form-control js-example-basic-single" name="investigacion_ui" style="width: 100%">
                                                        ...
                                                        @foreach($instituciones as $clave => $valor)
                                                            @php
                                                                $opcion = "$clave - $valor";
                                                            @endphp
                                                            <option value="{{ $opcion }}" {{ ($opcion == $ui) ? 'selected' : '' }}>{{ $opcion }}</option>
                                                        @endforeach
                                                    </select>
...
actualmente como Investigadora/or o CPA</span>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('carrera_cargo',['' => 'Seleccionar...'] + config('carreraCargos'), '',['class' => 'form-control','id'=>'carrera_cargo']) }}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('carrera_empleador',['' => 'Seleccionar...'] + config('carreraEmpleadores'), '',['class' => 'form-control','id'=>'carrera_empleador']) }}
                                            ...
                                            <div class="col-md-9">
                                                <div class="form-group">
                                                    ...
                                                    <select id="carrera_ui" class="form-control js-example-basic-single" name="carrera_ui" style="width: 100%">
                                                        <option value="">Seleccionar...</option>
                                                        @foreach($instituciones as $clave => $valor)
                                                            <option value="{{ $clave }} - {{ $valor }}">{{ $clave }} - {{ $valor }}</option>
                                                        @endforeach
                                                    </select>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="categorizacion">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('convocatoria_id',$convocatorias, '',['class' => 'form-control','id'=>'convocatoria_id']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-3" id="divMecanismo">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('mecanismo',['' => 'Seleccionar...'] + config('mecanismos'), '',['class' => 'form-control','id'=>'mecanismo']) }}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('presentacion_ua',['' => 'Seleccionar...'] + config('facultades'), '',['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'presentacion_ua']) }}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('categoria_spu',['' => 'Seleccionar...'] + config('spuCategorias'), '',['class' => 'form-control','id'=>'categoria_spu']) }}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('categoria_solicitada',['' => 'Seleccionar...'] + config('categorias'), '',['class' => 'form-control','id'=>'categoria_solicitada']) }}
                                                </div>
                                            </div>
                                            @can('administrador-general')
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('categoria_asignada',['' => 'Seleccionar...'] + config('categorias'), '',['class' => 'form-control','id'=>'categoria_asignada']) }}
                                                </div>
                                            </div>
                                            @endcan
                                        ...
                                        <div class="row">
                                            <x-select-areas :areas="$areas" :subareas="$subareas" />
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('beca_tipo',['' => 'Seleccionar...'] + config('becaTipos'), '',['class' => 'form-control','id'=>'beca_tipo']) }}
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('beca_entidad',['' => 'Seleccionar...'] + config('becaEntidades'), '',['class' => 'form-control','id'=>'beca_entidad']) }}
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('proyecto_entidad',['' => 'Seleccionar...'] + config('proyectoEntidades'), '',['class' => 'form-control','id'=>'proyecto_entidad']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
