...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                <i class="fa fa-microscope" aria-hidden="true"></i>Solicitudes SICADI
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a class='pull-right btn btn-success' href="{{ route('solicitud_sicadis.create') }}">Nuevo</a>
                        </div>
        ...
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                columns: [
                    ...
                    {data: 'categoria_spu', name: 'categoria_spu'},
                    {data: 'categoria_solicitada', name: 'categoria_solicitada'},
                    {data: 'mecanismo', name: 'mecanismo'},
                    {data: 'area', name: 'area'},
