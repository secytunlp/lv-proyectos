                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::select('tipo',[''=>'']+$miembroTipos, $miembro->tipo,['class' => 'form-control','disabled']) }}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('horas', 'Horas')}}
                                                    {{Form::number('horas',  $miembro, ['class' => 'form-control','placeholder'=>'Horas','disabled'])}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::checkbox('activo', 1,($miembro->activo)?true:false,['disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{Form::textarea('observaciones', $miembro->observaciones, ['class' => 'form-control','disabled'])}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('apellido', $miembro->apellido, ['class' => 'form-control','placeholder'=>'Apellido','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    {{Form::label('nombre', 'Nombre')}}
                                                    {{Form::text('nombre', $miembro->nombre, ['class' => 'form-control','placeholder'=>'Nombre','disabled'])}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('cuil', $miembro->cuil, ['class' => 'form-control','placeholder'=>'XX-XXXXXXXX-X','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    {{Form::label('email', 'Email')}}
                                                    {{Form::email('email', $miembro->email, ['class' => 'form-control','placeholder'=>'Email','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('nacimiento', 'Nacimiento')}}
                                                    {{Form::date('nacimiento', ($miembro->nacimiento) ? date('Y-m-d', strtotime($miembro->nacimiento)) : '', ['class' => 'form-control','disabled'])}}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('facultad_id',  $facultades,$miembro->facultad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'facultad_id','disabled'])}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::checkbox('estudiante', 1,($miembro->estudiante)?true:false,['disabled'])}}
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::select('cargos[]',$cargos, $miembro->cargo_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                            @php
                                                                $dedicaciones = config('dedicaciones');
                                                                unset($dedicaciones['Sin Dedicación']);
                                                            @endphp
                                                            <td>{{ Form::select('deddocs[]',['' => ''] + $dedicaciones, $miembro->deddoc,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::select('carrerainvs[]',$carrerainvs, $miembro->carrerainv_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                            <td>{{ Form::select('organismos[]',$organismos, $miembro->organismo_id,['class' => 'form-control', 'style' => 'width: 150px','disabled']) }}</td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::select('categorias[]',$categorias, $miembro->categoria_id,['class' => 'form-control', 'style' => 'width: 60px','disabled']) }}</td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::select('sicadis[]',$sicadis, $miembro->sicadi_id,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            {{Form::text('becas[]', $miembro->beca, ['class' => 'form-control','placeholder'=>'Beca','disabled'])}}
                                                        </tr>
