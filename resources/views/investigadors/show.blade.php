                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="datos_personales">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                {{Form::number('documento', $investigador->persona->documento, ['class' => 'form-control','placeholder'=>'Documento','disabled'])}}
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                {{Form::email('email', $investigador->persona->email, ['class' => 'form-control','placeholder'=>'Email','disabled'])}}
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                {{Form::label('genero', 'Género')}}
                                                {{ Form::select('genero',[''=>'Seleccionar...','F'=>'Mujer','MT'=>'Mujer-Trans','T'=>'Travesti','M'=>'Varón','VY'=>'Varón-Trans','NB'=>'No Binarie','O'=>'Otro','PN'=>'Prefiero no responder'], $investigador->persona->genero,['class' => 'form-control','id'=>'genero','disabled']) }}
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                {{Form::date('nacimiento', ($investigador->persona->nacimiento)?date('Y-m-d', strtotime($investigador->persona->nacimiento)):'', ['class' => 'form-control','disabled'])}}
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                {{Form::label('fallecimiento', 'Fallecimiento')}}
                                                {{Form::date('fallecimiento', ($investigador->persona->fallecimiento)?date('Y-m-d', strtotime($investigador->persona->fallecimiento)):'', ['class' => 'form-control','disabled'])}}
                                            </div>
                                        </div>
                                    </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('telefono', $investigador->persona->telefono, ['class' => 'form-control','placeholder'=>'Teléfono','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('calle', 'Calle')}}
                                                    {{Form::text('calle', $investigador->persona->calle, ['class' => 'form-control','placeholder'=>'Calle','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    {{Form::label('nro', 'Número')}}
                                                    {{Form::text('nro', $investigador->persona->nro, ['class' => 'form-control','placeholder'=>'Número','disabled'])}}
                                            ...
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('piso', $investigador->persona->piso, ['class' => 'form-control','placeholder'=>'Piso','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <div class="form-group">
                                                    {{Form::label('depto', 'Departamento')}}
                                                    {{Form::text('depto', $investigador->persona->depto, ['class' => 'form-control','placeholder'=>'Departamento','disabled'])}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('localidad', $investigador->persona->localidad, ['class' => 'form-control','placeholder'=>'Localidad','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    {{Form::label('provincia', 'Provincia')}}
                                                    {{Form::select('provincia_id', ['' => 'Seleccionar...'] + $provincias->toArray(),($investigador->persona->provincia)?$investigador->persona->provincia->id:'', ['class' => 'form-control js-example-basic-single','id'=>'provincia_id','disabled'])}}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('cp', $investigador->persona->cp, ['class' => 'form-control','placeholder'=>'Código Postal','disabled'])}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{Form::textarea('observaciones', $investigador->persona->observaciones, ['class' => 'form-control','disabled'])}}
                                        ...
                                        <fieldset style="border: 1px solid #ccc; padding: 10px;">
                                            ...
                                            <table class="table" style="width: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ Form::select('titulos[]',$titulos, $titulo->pivot->titulo_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled']) }}</td>
                                                    <td>{{Form::date('egresos[]', ($titulo->pivot->egreso)?date('Y-m-d', strtotime($titulo->pivot->egreso)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('carrera', $investigador->carrera, ['class' => 'form-control','placeholder'=>'Carrera','disabled'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('total', 'Total De Materias')}}
                                                    {{Form::number('total', $investigador->total, ['class' => 'form-control','placeholder'=>'Total De Materias','disabled'])}}
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::number('materias', $investigador->materias, ['class' => 'form-control','placeholder'=>'Aprobadas','disabled'])}}
                                                </div>
                                            </div>
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    @foreach ($investigador->tituloposts as $titulopost)
                                                        <tr>
                                                            ...
                                                            <td>{{ Form::select('tituloposts[]',$tituloposts, $titulopost->pivot->titulo_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled']) }}</td>
                                                            <td>{{Form::date('egresos[]', ($titulopost->pivot->egreso)?date('Y-m-d', strtotime($titulopost->pivot->egreso)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('cargos[]',$cargos, $cargo->pivot->cargo_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                        <td>{{ Form::select('deddocs[]',[''=>'','Exclusiva'=>'Exclusiva','Semi Exclusiva'=>'Semi Exclusiva','Simple'=>'Simple'], $cargo->pivot->deddoc,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                                        <td>{{Form::date('ingresos[]', ($cargo->pivot->ingreso)?date('Y-m-d', strtotime($cargo->pivot->ingreso)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                                        <td>{{ Form::select('facultads[]',$facultades, $cargo->pivot->facultad_id,['class' => 'form-control', 'style' => 'width: 300px','disabled']) }}</td>
                                                        <td>{{ Form::select('universidads[]',$universidades, $cargo->pivot->universidad_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 300px','disabled']) }}</td>
                                                        <td>{{Form::checkbox('activos[]', 1,($cargo->pivot->activo)?true:false,['disabled'])}}</td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::select('unidad_id',  $unidads,$investigador->unidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'unidad_id','disabled'])}}
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('carrerainvs[]',$carrerainvs, $carrerainv->pivot->carrerainv_id,['class' => 'form-control', 'style' => 'width: 200px','disabled']) }}</td>
                                                        <td>{{ Form::select('organismos[]',$organismos, $carrerainv->pivot->organismo_id,['class' => 'form-control', 'style' => 'width: 150px','disabled']) }}</td>
                                                        <td>{{Form::date('carringresos[]',  ($carrerainv->pivot->ingreso)?date('Y-m-d', strtotime($carrerainv->pivot->ingreso)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>


                                                        <td>{{ Form::radio('actual', 1, ($carrerainv->pivot->actual)?true:false,['id' => 'actual_1','disabled']) }}</td> <!-- Usamos un nombre único con el índice 1 -->
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('categorias[]',$categorias, $categoria->pivot->categoria_id,['class' => 'form-control', 'style' => 'width: 60px','disabled']) }}</td>
                                                        <td>{{ Form::select('catyears[]',['' => ''] +$years, $categoria->pivot->year,['class' => 'form-control', 'style' => 'width: 80px','disabled']) }}</td>
                                                        <td>{{Form::date('catnotificacions[]',  ($categoria->pivot->notificacion)?date('Y-m-d', strtotime($categoria->pivot->notificacion)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                                        <td>{{ Form::select('catuniversidads[]',$universidades, $categoria->pivot->universidad_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 300px','disabled']) }}</td>

                                                        <td>{{ Form::radio('catactual', 1, ($categoria->pivot->actual)?true:false,['id' => 'catactual_1','disabled']) }}</td> <!-- Usamos un nombre único con el índice 1 -->
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('sicadis[]',$sicadis, $sicadi->pivot->sicadi_id,['class' => 'form-control', 'style' => 'width: 120px','disabled']) }}</td>
                                                        <td>{{ Form::select('sicadiyears[]',$years, $sicadi->pivot->year,['class' => 'form-control', 'style' => 'width: 80px','disabled']) }}</td>
                                                        <td>{{Form::date('sicadinotificacions[]', ($sicadi->pivot->notificacion)?date('Y-m-d', strtotime($sicadi->pivot->notificacion)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>


                                                        <td>{{ Form::radio('sicadiactual', 1, ($sicadi->pivot->actual)?true:false,['id' => 'sicadiactual_1','disabled']) }}</td> <!-- Usamos un nombre único con el índice 1 -->
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ Form::select('institucions[]',[''=>'','ANPCyT'=>'ANPCyT','CIC'=>'CIC','CONICET'=>'CONICET','UNLP'=>'UNLP','CIN'=>'CIN','OTRA'=>'OTRA'], $beca->institucion,['class' => 'form-control institucion_select', 'style' => 'width: 150px','disabled']) }}</td>
                                                        ...
                                                        <td>{{Form::date('becadesdes[]', ($beca->desde)?date('Y-m-d', strtotime($beca->desde)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>

                                                        <td>{{Form::date('becahastas[]', ($beca->hasta)?date('Y-m-d', strtotime($beca->hasta)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])}}</td>
                                                        <td>{{Form::checkbox('becaunlps[]', 1,($beca->unlp)?true:false,['disabled'])}}</td>
