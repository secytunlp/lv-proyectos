            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('titulos.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-offset-3 col-lg-6 col-md-3">
                                        <div class="form-group">
                                            ...
                                            {{ Form::select('nivel',['Grado'=>'Grado','Posgrado'=>'Posgrado'], '',['class' => 'form-control','id'=>'nivel']) }}
                                        </div>
                                    </div>
                                    <div class="col-lg-offset-3 col-lg-6 col-md-4">
                                        <div class="form-group">
                                            {{Form::label('universidad', 'Universidad')}}
                                            {{Form::select('universidad_id', $universidads,'', ['class' => 'form-control js-example-basic-single','id'=>'universidad_id'])}}
                                        </div>
