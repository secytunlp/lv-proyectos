    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Alta de unidad de investigación</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('unidad_investigacions.store') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="box-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::date('fecha_disposicion', '', ['class' => 'form-control'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    {{Form::label('disposicion', 'Nro. Disposición')}}
                                                    {{Form::text('disposicion', '', ['class' => 'form-control','placeholder'=>'Nro. Disposición'])}}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('objetivos', '', ['class' => 'form-control', 'id' => 'objetivos']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('lineas', '', ['class' => 'form-control', 'id' => 'lineas']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('justificacion', '', ['class' => 'form-control', 'id' => 'justificacion']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('produccion', '', ['class' => 'form-control', 'id' => 'produccion']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('proyectos', '', ['class' => 'form-control', 'id' => 'proyectos']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('rrhh', '', ['class' => 'form-control', 'id' => 'rrhh']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('funciones', '', ['class' => 'form-control', 'id' => 'funciones-id']) }}
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea('equipamiento', '', ['class' => 'form-control', 'id' => 'equipamiento']) }}
                                                </div>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <!--<tr>
                                                        ...
                                                        <td>{{ Form::select('facultads[]',$facultades, '',['class' => 'form-control', 'style' => 'width: 200px']) }}</td>
