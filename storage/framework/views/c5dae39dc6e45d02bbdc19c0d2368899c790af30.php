            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo e(route('integrantes.remove',$integrante->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php echo e(Form::date('baja', '', ['class' => 'form-control'])); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <?php echo e(Form::label('consecuencias', 'Explicar las consecuencias de la baja en el desenvolvimiento del proyecto')); ?>

                                            <?php echo e(Form::textarea('consecuencias', '', ['class' => 'form-control'])); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <?php echo e(Form::label('motivos', 'Explicar los motivos de la baja')); ?>

                                            <?php echo e(Form::textarea('motivos', '', ['class' => 'form-control'])); ?>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <?php echo e(Form::label('considerando', 'Considerando la baja, indicar si el el proyecto cumple con los siguientes requisitos')); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <?php
                                                $mininteLabel = 'Mínimo ' . \App\Constants::MINIMO_INTEGRANTES . ' integrantes con lugar de trabajo en la UNLP (NO alumnos)';
                                            ?>
                                            <?php echo e(Form::label('minint', $mininteLabel)); ?>

                                            <?php echo e(Form::checkbox('minint', 1, false)); ?>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <?php
                                                $mindedLabel = 'Mínimo ' . \App\Constants::MINIMO_MAYOR_DEDICACION . ' integrantes con mayor dedicación en la Unidad Académica que se presenta el proyecto';
                                            ?>
                                            <?php echo e(Form::label('minded', $mindedLabel)); ?>

                                            <?php echo e(Form::checkbox('minded', 1, false)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/integrantes/baja.blade.php ENDPATH**/ ?>