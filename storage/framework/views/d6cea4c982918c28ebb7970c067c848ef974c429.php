                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('tipo',[''=>'','Investigador Formado'=>'Investigador Formado','Investigador En Formación'=>'Investigador En Formación','Becario, Tesista'=>'Becario, Tesista','Colaborador'=>'Colaborador'], $integrante->tipo,['class' => 'form-control'])); ?>
                                    ...
                                    <div role="tabpanel" class="tab-pane" id="datos_personales">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text('apellido', $integrante->investigador->persona->apellido, ['class' => 'form-control','placeholder'=>'Apellido'])); ?>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text('nombre', $integrante->investigador->persona->nombre, ['class' => 'form-control','placeholder'=>'Nombre'])); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::text('cuil', $integrante->investigador->persona->cuil, ['class' => 'form-control','placeholder'=>'XX-XXXXXXXX-X'])); ?>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('becas[]',obtenerOpcionesBecaPorInstitucion($integrante->institucion), $integrante->beca,['class' => 'form-control beca_select', 'style' => 'width: 150px'])); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/integrantes/edit.blade.php ENDPATH**/ ?>