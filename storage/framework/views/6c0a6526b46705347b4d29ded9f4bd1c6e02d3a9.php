...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="login-links">
            <a href="<?php echo e(route('password.request')); ?>" class="btn btn-info">Olvidé mi clave</a>
            <a href="<?php echo e(route('register')); ?>" class="btn btn-success">Registrarse</a>
        </div>
...
<?php /**PATH /var/www/sicadi/resources/views/auth/login.blade.php ENDPATH**/ ?>