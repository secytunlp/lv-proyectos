                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a class='pull-right btn btn-success' href="<?php echo e(route('users.create')); ?>">Nuevo</a>
                        </div>
            ...
            $('#example1').DataTable({
                ...
                columns: [
                    { data: 'image', name: 'image', render: function(data, type, row) {
                            if (data) {
                                return '<img src="<?php echo e(asset('')); ?>' + data + '" class="img-circle" width="50px">';
                            } else {
                                return '<img src="<?php echo e(url('images/user.png')); ?>" class="img-circle">';
                            }
                        } },
                    { data: 'name', name: 'name' },
                    { data: 'cuil', name: 'cuil' },
                    ...
                    // Actions column
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('usuario-editar')): ?>
                                actionsHtml += '<a href="<?php echo e(route("users.edit", ":id")); ?>" alt="Editar" title="Editar"><span class="glyphicon glyphicon-edit"></span></a>'.replace(':id', row.id);
                            <?php endif; ?>
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('usuario-eliminar')): ?>
                                actionsHtml += '<form id="delete-form-' + row.id + '" method="post" action="<?php echo e(route('users.destroy', '')); ?>/' + row.id + '" style="display: none">';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/users/index.blade.php ENDPATH**/ ?>