            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo e(route('integrantes.update',$integrante->id)); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="datos_proyecto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('tipo',[''=>'','Director'=>'Director','Codirector'=>'Codirector','Investigador Formado'=>'Investigador Formado','Investigador En Formación'=>'Investigador En Formación','Becario, Tesista'=>'Becario, Tesista','Colaborador'=>'Colaborador'], $integrante->tipo,['class' => 'form-control','disabled'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::number('horas', $integrante->horas, ['class' => 'form-control','placeholder'=>'Horas','disabled'])); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    <?php echo e(Form::label('alta', 'Fecha de alta')); ?>

                                                    <?php echo e(Form::date('alta', ($integrante->alta)?date('Y-m-d', strtotime($integrante->alta)):'', ['class' => 'form-control','disabled'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    <?php echo e(Form::label('baja', 'Fecha de baja')); ?>

                                                    <?php echo e(Form::date('baja', ($integrante->baja)?date('Y-m-d', strtotime($integrante->baja)):'', ['class' => 'form-control','disabled'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('estado', $integrante->estado, ['class' => 'form-control','disabled'])); ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if(!empty($integrante->curriculum)): ?>
                                                        <a href="<?php echo e(url($integrante->curriculum)); ?>" target="_blank">Descargar Curriculum</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php if(!empty($integrante->actividades)): ?>
                                                        <a href="<?php echo e(url($integrante->actividades)); ?>" target="_blank">Descargar Plan</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('nacimiento', ($integrante->nacimiento)?date('Y-m-d', strtotime($integrante->nacimiento)):'', ['class' => 'form-control','disabled'])); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('facultad_id',  $facultades,$integrante->facultad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'facultad_id','disabled'])); ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('universidad_id',  $universidades,$integrante->universidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'universidad_id','disabled'])); ?>
                                        ...
                                        <fieldset style="border: 1px solid #ccc; padding: 10px;">
                                            ...
                                            <table class="table" style="width: 50%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(Form::select('titulos[]',$titulos, $integrante->titulo_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled'])); ?></td>
                                                    <td><?php echo e(Form::date('egresos[]', ($integrante->egresogrado)?date('Y-m-d', strtotime($integrante->egresogrado)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('carrera', $integrante->carrera, ['class' => 'form-control','placeholder'=>'Carrera','disabled'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::number('total', $integrante->total, ['class' => 'form-control','placeholder'=>'Total De Materias','disabled'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::number('materias', $integrante->materias, ['class' => 'form-control','placeholder'=>'Aprobadas','disabled'])); ?>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('tituloposts[]',$tituloposts, $integrante->titulopost_id,['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::date('egresoposts[]', ($integrante->egresoposgrado)?date('Y-m-d', strtotime($integrante->egresoposgrado)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('cargos[]',$cargos, $integrante->cargo_id,['class' => 'form-control', 'style' => 'width: 200px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::select('deddocs[]',[''=>'','Exclusiva'=>'Exclusiva','Semi Exclusiva'=>'Semi Exclusiva','Simple'=>'Simple'], $integrante->deddoc,['class' => 'form-control', 'style' => 'width: 120px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::date('ingresos[]', ($integrante->alta_cargo)?date('Y-m-d', strtotime($integrante->alta_cargo)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('unidad_id',  $unidads,$integrante->unidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'unidad_id','disabled'])); ?>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('carrerainvs[]',$carrerainvs, $integrante->carrerainv_id,['class' => 'form-control', 'style' => 'width: 200px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::select('organismos[]',$organismos, $integrante->organismo_id,['class' => 'form-control', 'style' => 'width: 150px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::date('carringresos[]', ($integrante->ingreso_carrera)?date('Y-m-d', strtotime($integrante->ingreso_carrera)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('categorias[]',$categorias, $integrante->categoria_id,['class' => 'form-control', 'style' => 'width: 60px','disabled'])); ?></td>
                                                ...
                                                <table class="table" style="width: 50%">
                                                  ...
                                                  <th>Actual</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('sicadis[]',$sicadis, $integrante->sicadi_id,['class' => 'form-control', 'style' => 'width: 120px','disabled'])); ?></td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('institucions[]',[''=>'','ANPCyT'=>'ANPCyT','CIC'=>'CIC','CONICET'=>'CONICET','UNLP'=>'UNLP','CIN'=>'CIN','OTRA'=>'OTRA'], $integrante->institucion,['class' => 'form-control institucion_select', 'style' => 'width: 150px','disabled'])); ?></td>
                                                        <td><?php echo e(Form::select('becas[]',\App\Helpers\BecaHelper::obtenerOpcionesBecaPorInstitucion($integrante->institucion), $integrante->beca,['class' => 'form-control beca_select', 'style' => 'width: 150px','disabled'])); ?></td>

                                                        <td><?php echo e(Form::date('becadesdes[]', ($integrante->alta_beca)?date('Y-m-d', strtotime($integrante->alta_beca)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>

                                                        <td><?php echo e(Form::date('becahastas[]',  ($integrante->baja_beca)?date('Y-m-d', strtotime($integrante->baja_beca)):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <?php if(!empty($integrante->resolucion)): ?>
                                                        <a href="<?php echo e(url($integrante->resolucion)); ?>" target="_blank">Descargar Resolución</a>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/integrantes/show.blade.php ENDPATH**/ ?>