                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados <?php if($viaje_evaluacion): ?> - <?php echo e($viaje_evaluacion->viaje->investigador->persona->apellido); ?> <?php echo e($viaje_evaluacion->viaje->investigador->persona->nombre); ?> en la evaluación <?php echo e($viaje_evaluacion->viaje->periodo->nombre); ?><?php endif; ?></h3>
                            <?php if($viaje_evaluacion): ?><a class='pull-right btn btn-success' href="<?php echo e(route('viaje_evaluacion_estados.create', ['viaje_evaluacion_id' => $viaje_evaluacion->id])); ?>">Cambiar</a><?php endif; ?>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('viaje_evaluacion_estados.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
                        d._token = '<?php echo e(csrf_token()); ?>'; // Agrega el token CSRF si estás usando Laravel
                        d.viaje_evaluacion_id = '<?php echo e($viaje_evaluacion ? $viaje_evaluacion->id : ''); ?>'; // Enviar el ID del viaje_evaluacion como filtro
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/viaje_evaluacion_estados/index.blade.php ENDPATH**/ ?>