                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados <?php if($viaje): ?> - <?php echo e($viaje->investigador->persona->apellido); ?> <?php echo e($viaje->investigador->persona->nombre); ?> en la solicitud <?php echo e($viaje->periodo->nombre); ?><?php endif; ?></h3>
                            <?php if($viaje): ?><a class='pull-right btn btn-success' href="<?php echo e(route('viaje_estados.create', ['viaje_id' => $viaje->id])); ?>">Cambiar</a><?php endif; ?>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('viaje_estados.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/viaje_estados/index.blade.php ENDPATH**/ ?>