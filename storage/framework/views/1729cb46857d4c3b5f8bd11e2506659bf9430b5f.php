    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(route('viaje_evaluacions.index')); ?>">Evaluaciones</a></li>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Evaluaciones <?php if($viaje): ?> - <?php echo e($viaje->investigador->persona->apellido); ?> <?php echo e($viaje->investigador->persona->nombre); ?> - Período - <?php echo e($viaje->periodo->nombre); ?><?php endif; ?></h3>
                            <?php if($viaje): ?>

                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('integrante_estado-crear')): ?>
                                    <a style="margin-left: 5px;" class='pull-right btn btn-danger' href="<?php echo e(route('viaje_evaluacions.actualizar', ['viaje_id' => $viaje->id])); ?>">Actualizar puntaje</a>
                                <?php endif; ?>
                                <a style="margin-left: 5px;" class='pull-right btn btn-info' href="<?php echo e(route('viaje_evaluacions.enviar', ['viaje_id' => $viaje->id])); ?>" onclick="return confirmarEnvio();">Enviar a Evaluadores</a>

                                <a  class='pull-right btn btn-success ml' href="<?php echo e(route('viaje_evaluacions.create', ['viaje_id' => $viaje->id])); ?>">Asignar Evaluadores</a>
                                        ...
                                        <select id="filtroPeriodo" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($periodo->id); ?>"
                                                    <?php echo e($periodo->nombre == $currentPeriod ? 'selected' : ''); ?>>
    ...
    <script>
        $(document).ready(function() {
            var table = $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('viaje_evaluacions.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
                        d._token = '<?php echo e(csrf_token()); ?>'; // Agrega el token CSRF si estás usando Laravel
                        d.viaje_id = '<?php echo e($viaje ? $viaje->id : ''); ?>'; // Enviar el ID del viaje como filtro
                ...
                columns: [
                    ...
                    {data: 'puntaje', name: 'puntaje'},
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('joven_evaluacion_estado-listar')): ?>
                                actionsHtml += '<a href="<?php echo e(route("viaje_evaluacion_estados.index")); ?>?viaje_evaluacion_id=' + row.id + '" alt="Estados" title="Estados" style="margin-right: 5px;"><i class="fa fa-tasks"></i></a>';
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('evaluacion-listar')): ?>
                                if ((row.estado == 'En evaluación')||(row.estado == 'Evaluada')||(row.estado == 'Rectificada')) {
                                    actionsHtml += '<a href="<?php echo e(route("viaje_evaluacions.evaluacion-pdf")); ?>?viaje_evaluacion_id=' + row.id + '" alt="Evaluación" title="Evaluación" target="_blank" style="margin-right: 5px;"><i class="fa fa-file-pdf"></i></a>';
                                }
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/viaje_evaluacions/index.blade.php ENDPATH**/ ?>