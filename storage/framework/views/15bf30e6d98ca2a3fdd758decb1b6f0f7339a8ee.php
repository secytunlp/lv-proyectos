                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h3 class="box-title">Estados <?php if($joven_evaluacion): ?> - <?php echo e($joven_evaluacion->joven->investigador->persona->apellido); ?> <?php echo e($joven_evaluacion->joven->investigador->persona->nombre); ?> en la evaluación <?php echo e($joven_evaluacion->joven->periodo->nombre); ?><?php endif; ?></h3>
                            <?php if($joven_evaluacion): ?><a class='pull-right btn btn-success' href="<?php echo e(route('joven_evaluacion_estados.create', ['joven_evaluacion_id' => $joven_evaluacion->id])); ?>">Cambiar</a><?php endif; ?>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('joven_evaluacion_estados.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
                        d._token = '<?php echo e(csrf_token()); ?>'; // Agrega el token CSRF si estás usando Laravel
                        d.joven_evaluacion_id = '<?php echo e($joven_evaluacion ? $joven_evaluacion->id : ''); ?>'; // Enviar el ID del joven_evaluacion como filtro
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/joven_evaluacion_estados/index.blade.php ENDPATH**/ ?>