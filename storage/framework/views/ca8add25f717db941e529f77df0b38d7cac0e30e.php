    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ...
                <small>Cambio de Dedicación Horaria</small>
            </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo e(route('integrantes.cambiarHS',$integrante->id)); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div role="tabpanel" class="tab-pane active" id="datos_proyecto">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="cambio" value="<?php echo e(($integrante->cambio)?date('Y-m-d', strtotime($integrante->cambio)):''); ?>">
                                                    <input type="hidden" name="horas_anteriores" value="<?php echo e(($integrante->horas_anteriores)?$integrante->horas_anteriores:$integrante->horas); ?>">
                                                    <?php echo e(Form::label('tipo', 'Tipo')); ?>

                                                    <?php echo e(Form::select('tipo',[''=>'','Director'=>'Director','Codirector'=>'Codirector','Investigador Formado'=>'Investigador Formado','Investigador En Formación'=>'Investigador En Formación','Becario, Tesista'=>'Becario, Tesista'], $integrante->tipo,['class' => 'form-control','disabled'])); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <div class="form-group">
                                                    <?php echo e(Form::label('cambio', 'Fecha de cambio')); ?>
                                            ...
                                            <div class="col-md-6" id="divReducccion">
                                                ...
                                                <div class="form-group">
                                                    <?php echo e(Form::label('reduccion', 'En el caso de ser una reducción horaria, especificar las consecuencias que la misma tendrá en el desarrollo del proyecto')); ?>

                                                    <?php echo e(Form::textarea('reduccion', $integrante->reduccion, ['class' => 'form-control'])); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::email('email', $integrante->email, ['class' => 'form-control','placeholder'=>'Email'])); ?>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <?php echo e(Form::date('nacimiento', ($integrante->nacimiento)?date('Y-m-d', strtotime($integrante->nacimiento)):'', ['class' => 'form-control'])); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('facultad_id',  $facultades,$integrante->facultad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'facultad_id'])); ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('universidad_id',  $universidades,$integrante->universidad_id, ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'universidad_id'])); ?>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('carrerainvs[]',$carrerainvs, $integrante->carrerainv_id,['class' => 'form-control', 'style' => 'width: 200px'])); ?></td>
                                                        <td><?php echo e(Form::select('organismos[]',$organismos, $integrante->organismo_id,['class' => 'form-control', 'style' => 'width: 150px'])); ?></td>
                                                        <td><?php echo e(Form::date('carringresos[]', ($integrante->ingreso_carrera)?date('Y-m-d', strtotime($integrante->ingreso_carrera)):'', ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                            ...
                                            <div class="form-group col-md-12">
                                                ...
                                                <table class="table" style="width: 50%">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(Form::select('becas[]',obtenerOpcionesBecaPorInstitucion(old('institucions.0', $integrante->institucion)), $integrante->beca,['class' => 'form-control beca_select', 'style' => 'width: 150px'])); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/integrantes/cambioHS.blade.php ENDPATH**/ ?>