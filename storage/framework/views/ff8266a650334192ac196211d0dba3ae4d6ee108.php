                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <a class='pull-right btn btn-success' href="<?php echo e(route('investigadors.create')); ?>">Nuevo</a>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('investigadors.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "render": function(data, type, row) {
                            ...
                            var actionsHtml = '';
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('investigador-listar')): ?>
                                actionsHtml += '<a href="<?php echo e(route("investigadors.show", ":id")); ?>" alt="Ver" title="Ver" style="margin-right: 5px;"><span class="glyphicon glyphicon-eye-open"></span></a>'.replace(':id', row.id);
                            <?php endif; ?>
                            // Agregar enlace de edición si el usuario tiene permiso
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('investigador-editar')): ?>
                                actionsHtml += '<a href="<?php echo e(route("investigadors.edit", ":id")); ?>" alt="Editar" title="Editar" style="margin-right: 5px;"><span class="glyphicon glyphicon-edit"></span></a>'.replace(':id', row.id);
                            <?php endif; ?>

                            // Agregar formulario de eliminación si el usuario tiene permiso
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('investigador-eliminar')): ?>
                                actionsHtml += '<form id="delete-form-' + row.id + '" method="post" action="<?php echo e(route('investigadors.destroy', '')); ?>/' + row.id + '" style="display: none">';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/investigadors/index.blade.php ENDPATH**/ ?>