            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo e(route('jovens.store')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="investigador_id" value="<?php echo e($investigador->id ?? ''); ?>">
                            <input type="hidden" name="periodo_id" value="<?php echo e($periodo->id ?? ''); ?>">
                            <div class="box-body">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::select('titulos[]',$titulos, ($titulo)?$titulo->id:'',['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px'])); ?></td>
                                                            <td><?php echo e(Form::date('egresos[]', ($titulo) ?
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::select('tituloposts[]',$tituloposts, ($titulopost)?$titulopost->id:'',['class' => 'form-control js-example-basic-single', 'style' => 'width: 400px'])); ?></td>
                                                            <td><?php echo e(Form::date('egresoposts[]', ($titulopost) ?
            (($titulopost->pivot->egreso) ? date('Y-m-d', strtotime($titulopost->pivot->egreso)) : '')
            : '',  ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                            <td><?php echo e(Form::checkbox('doctorados[]', 1,false)); ?></td>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::select('cargos[]',$cargos, ($cargo)?$cargo->id:'',['class' => 'form-control', 'style' => 'width: 200px'])); ?></td>
                                                            <td><?php echo e(Form::select('deddocs[]',[''=>'','Exclusiva'=>'Exclusiva','Semi Exclusiva'=>'Semi Exclusiva','Simple'=>'Simple'], ($cargo)?$cargo->pivot->deddoc:'',['class' => 'form-control', 'style' => 'width: 120px'])); ?></td>
                                                            <td><?php echo e(Form::date('ingresos[]', ($cargo) ?
            (($cargo->pivot->ingreso) ? date('Y-m-d', strtotime($cargo->pivot->ingreso)) : '')
            : '', ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                            <td><?php echo e(Form::select('facultads[]',$facultades, ($cargo)?$cargo->pivot->facultad_id:'',['class' => 'form-control', 'style' => 'width: 300px'])); ?></td>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::text('disciplina', '', ['class' => 'form-control','placeholder'=>'Disciplina'])); ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::select('carrerainvs[]',$carrerainvs, ($carrerainv)?$carrerainv->id:'',['class' => 'form-control', 'style' => 'width: 200px'])); ?></td>
                                                            <td><?php echo e(Form::select('organismos[]',$organismos, ($carrerainv)?$carrerainv->pivot->organismo_id:'',['class' => 'form-control', 'style' => 'width: 150px'])); ?></td>
                                                            <td><?php echo e(Form::date('carringresos[]', ($carrerainv) ?
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('unidadcarrera_id',  $unidads,'', ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'unidadcarrera_id'])); ?>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e(Form::select('institucionActual',[''=>'','ANPCyT'=>'ANPCyT','CIC'=>'CIC','CONICET'=>'CONICET','UNLP'=>'UNLP','CIN'=>'CIN','OTRA'=>'OTRA'], ($beca)?$beca->institucion:'',['class' => 'form-control institucionActual_select', 'style' => 'width: 150px'])); ?></td>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    <div class="form-group">
                                                        ...
                                                        <?php echo e(Form::select('unidadbeca_id',  $unidads,'', ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'unidadbeca_id'])); ?>
                                                    ...
                                                    <table class="table" style="width: 50%">
                                                        ...
                                                        <?php $__currentLoopData = $institucions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $institucion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo e(Form::select('becas[]', \App\Helpers\BecaHelper::obtenerOpcionesBecaPorInstitucionAnterior($institucion), $becasSeleccionadas[$index], ['class' => 'form-control beca_select', 'style' => 'width: 150px'])); ?>

                                                                </td>
                                                                <td><?php echo e(Form::date('becadesdes[]', $becadesdes[$index], ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                <td><?php echo e(Form::date('becahastas[]', $becahastas[$index], ['class' => 'form-control', 'style' => 'width:150px;'])); ?>

                                                                    <?php echo e(Form::hidden('becaagregadas[]', $becaagregadas[$index])); ?>
                                        ...
                                        <div class="row" style="margin: 10px;">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::checkbox('director', 1,false)); ?>
                                                    ...
                                                    <table class="table" style="width: 100%">
                                                        ...
                                                        <?php $__currentLoopData = $proyectosAnteriores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $proyectoAnt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo e(Form::text('codigoAnteriorOld[]', $proyectoAnt['codigo'], ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                                                ...
                                                                <td><?php echo e(Form::date('inicioAnteriorOld[]', ($proyectoAnt['inicio'])?date('Y-m-d', strtotime($proyectoAnt['inicio'])):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                                                <td><?php echo e(Form::date('finAnteriorOld[]', ($proyectoAnt['fin'])?date('Y-m-d', strtotime($proyectoAnt['fin'])):'', ['class' => 'form-control', 'style' => 'width:150px;','disabled'])); ?></td>
                                                        ...
                                                        <?php for($i = 0; $i < $totalOlds; $i++): ?>
                                                            ...
                                                            <tr>
                                                                <td><?php echo e(Form::text('codigoAnterior[]', $codigo, ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                <td><?php echo e(Form::textarea('tituloAnterior[]', $titulo, ['class' => 'form-control', 'style' => 'width:450px;', 'rows' => 2])); ?></td>
                                                                <td><?php echo e(Form::text('directorAnterior[]', $director, ['class' => 'form-control', 'style' => 'width:200px;'])); ?></td>
                                                                <td><?php echo e(Form::date('inicioAnterior[]', $inicio, ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                <td><?php echo e(Form::date('finAnterior[]', $fin, ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                     <td><a href="#" class="btn btn-danger removeProyecto"><i class="glyphicon glyphicon-remove"></i></a></td>
                                                            </tr>
                                                        <?php endfor; ?>
                                                        </tbody>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::textarea('objetivo', '', ['class' => 'form-control'])); ?>
...
a) detallar el mismo y b) justificar su pedido. En el caso de solicitar bibliografía deberá indicar título, autor, editorial, etc.')); ?>
                                                    ...
                                                    <?php echo e(Form::textarea('justificacion', '', ['class' => 'form-control'])); ?>
                                                        ...
                                                        <table class="table" style="width: 70%">
                                                            ...
                                                            <?php if(old('presupuesto'.$tipoPresupuesto->id.'fechas')): ?>
                                                                <?php $__currentLoopData = old('presupuesto'.$tipoPresupuesto->id.'fechas'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $fecha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                    <tr>
                                                                        <td><?php echo e(Form::date('presupuesto'.$tipoPresupuesto->id.'fechas[]', $fecha, ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                        ...
                                                                        <?php else: ?>
                                                                            <td><?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'detalles[]', old('presupuesto'.$tipoPresupuesto->id.'detalles.'.$index), ['class' => 'form-control', 'style' => 'width: 400px'])); ?></td>
                                                                        <?php endif; ?>
                                                                        <td><?php echo e(Form::number('presupuesto'.$tipoPresupuesto->id.'importes[]', old('presupuesto'.$tipoPresupuesto->id.'importes.'.$index), ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                        <td><a href="#" class="btn btn-danger removePresupuesto"><i class="glyphicon glyphicon-remove"></i></a></td>
                                                                    </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            <?php else: ?>
                                                                <tr>
                                                                    <td><?php echo e(Form::date('presupuesto'.$tipoPresupuesto->id.'fechas[]', '', ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                    ...
                                                                    <?php if($tipoPresupuesto->id == 2): ?>
                                                                        <td>
                                                                            <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 10px;">
                                                                                ...
                                                                                <div class="extra-fields" style="display: flex; gap: 10px; align-items: center;">
                                                                                    <?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'dias[]', '',
                                                                                        ['class' => 'form-control ds_dias', 'placeholder' => 'Días', 'style' => 'display:none; width:150px'])); ?>


                                                                                    <?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'lugar[]', '',
                                                                                    ...
                                                                                    <?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'destino[]', '',
                                                                                        ['class' => 'form-control ds_destino', 'placeholder' => 'Destino', 'style' => 'display:none; width:150px'])); ?>


                                                                                    <?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'inscripcion[]', '',
                                                                                        ['class' => 'form-control ds_inscripcion', 'placeholder' => 'Descripción', 'style' => 'display:none; width:150px'])); ?>


                                                                                    <?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'otros[]', '',
                                                                    ...
                                                                    <?php else: ?>
                                                                        <td><?php echo e(Form::text('presupuesto'.$tipoPresupuesto->id.'detalles[]','',['class' => 'form-control', 'style' => 'width: 400px'])); ?></td>
                                                                    <?php endif; ?>
                                                                    <td><?php echo e(Form::number('presupuesto'.$tipoPresupuesto->id.'importes[]', '', ['class' => 'form-control', 'style' => 'width:150px;'])); ?></td>
                                                                    <td><a href="#" class="btn btn-danger removePresupuesto"><i class="glyphicon glyphicon-remove"></i></a></td>
                                                                </tr>
                                                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/jovens/create.blade.php ENDPATH**/ ?>