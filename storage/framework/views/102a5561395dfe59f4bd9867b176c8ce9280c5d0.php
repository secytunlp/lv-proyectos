            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" action="<?php echo e(route('integrantes.store')); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('tipo',[''=>'','Investigador Formado'=>'Investigador Formado','Investigador En Formación'=>'Investigador En Formación','Becario, Tesista'=>'Becario, Tesista','Colaborador'=>'Colaborador'], '',['class' => 'form-control'])); ?>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::number('horas', '', ['class' => 'form-control','placeholder'=>'Horas'])); ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('facultad_id',  $facultades,'', ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'facultad_id'])); ?>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <?php echo e(Form::select('universidad_id',  $universidades,'', ['class' => 'form-control js-example-basic-single', 'style' => 'width: 100%','id'=>'universidad_id'])); ?>
        ...
        $(document).ready(function () {
            ...
            $('#apellido').autocomplete({
                source: function(request, response) {
                    $.ajax({
                        url: '<?php echo e(route("integrantes.buscarInvestigador")); ?>', // Asegúrate de que la ruta es correcta
                        dataType: 'json',
                        data: {
                            term: request.term
                        },
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/integrantes/create.blade.php ENDPATH**/ ?>