            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form role="form" id="formEvaluar" action="<?php echo e(route('joven_evaluacions.saveEvaluar',$evaluacion->id)); ?>" method="post" enctype="multipart/form-data" onsubmit="return prepararEnvio();">
                            <?php echo e(csrf_field()); ?>

                            <?php echo e(method_field('PUT')); ?>

                            <?php echo e(Form::hidden('joven_evaluacion_planilla_id', $planilla->id)); ?>
...
<fieldset>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <span><?php echo e($joven->investigador->persona->apellido); ?> <?php echo e($joven->investigador->persona->nombre); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>U. Académica:</label>
                                                    <span><?php echo e($facultad->nombre); ?></span>
                                                </div>
                                            </div>
                                    ...
                                    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666 ;margin-bottom:5px">
                                        <tbody><tr style="border-style: solid; border-width: 1px; border-color: #666">
                                            <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;">
                                                <?php echo e($primerPosgrado->nombre); ?></td> <td style="background-color: #eee;color:#333;" colspan="6"><div align="center"><strong>ANTECEDENTES  ACADÉMICOS DEL SOLICITANTE</strong></div></td>
                                        </tr>
                                        <tr style="border-style: solid; border-width: 1px; border-color: #666">
                                            ...
                                            <td style="background-color: #eee;color:#333;" colspan="6"><div align="left">Título de Posgrado:
                                                    <strong>hasta <?php echo e($maxPosgrado); ?> puntos</strong> más por el título de posgrado obtenido en la
                                                    especialidad (si lo hubiere) </div></td>
                                        </tr>
                                        <tr style="border-style: solid; border-width: 1px; border-color: #666"><td style="background-color: #eee;color:#333; width:80px"><?php echo e($primerPosgrado->nombre); ?>1<br><strong>Max. <?php echo e($maxPosgrado); ?>pt.</strong></td><td style="background-color: #fff; border-width: 0px; border-color: #fff">
                                                <?php $__currentLoopData = $posgradoMaximos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $posgradoMaximo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php
                                                    ...
                                                    <input name="joven_planilla_posgrado_max_id" id="joven_planilla_posgrado_max_id<?php echo e($iterarPosgrado); ?>" type="radio" value="<?php echo e($posgradoMaximo->id); ?>-<?php echo e($posgradoMaximo->maximo); ?>" onclick="sumar_total();"<?php echo e($checked); ?>'>
                                                    <input name="posgrado_maxiomo<?php echo e($iterarPosgrado); ?>" id="posgrado_maxiomo<?php echo e($iterarPosgrado); ?>" type="hidden" value="<?php echo e($posgradoMaximo->maximo); ?>"><?php echo e($posgradoMaximo->posgrado_nombre); ?> (<?php echo e($posgradoMaximo->maximo); ?>pt.)</td><td style="background-color: #fff; border-width: 0px; border-color: #fff">
                                                <?php
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666;margin-bottom:5px">
        <tbody>
        <input type="hidden" name="cantantacad" id="cantantacad" value="<?php echo e($antAcadMaximos->count()); ?>">
        <?php $__currentLoopData = $antAcadMaximos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $antAcadMaximo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if(($antAcadMaximo->minimo==0)&&($antAcadMaximo->tope==0)&&($antAcadMaximo->minimo==$antAcadMaximo->maximo)): ?>
                ...
                ?>
                <tr>
                    <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;"><?php echo e($antAcadMaximo->grupo_nombre); ?><?php echo e($iterarAntAcad+2); ?><br></td>
                ...
                <tr>
                    <td style="background-color: #eee;color:#333; width:80px"></td>
                    <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;"><?php echo e($antAcadMaximo->ant_acad_nombre); ?></td>
                    <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;">
                        <input type="hidden" name="maxantacad<?php echo e($iterarAntAcad); ?>" id="maxantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->maximo); ?>">
                        <input type="hidden" name="topeantacad<?php echo e($iterarAntAcad); ?>" id="topeantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->tope); ?>">
                        <input type="hidden" name="minantacad<?php echo e($iterarAntAcad); ?>" id="minantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->minimo); ?>">
                        <input type="hidden" name="ant_acad_evaluacion_grupo_id<?php echo e($iterarAntAcad); ?>" id="ant_acad_evaluacion_grupo_id<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->evaluacion_grupo_id); ?>">
                        Posgrado Sup. Especialidad:
                        <input type="checkbox" size="5" name="posgrado<?php echo e($iterarAntAcad); ?>" id="posgrado" value="2" disabled="" onclick="sumar_total();" <?php echo e($checkedposgrado); ?>>
                    </td>
                    <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;">
                        <input type="hidden" name="factor" id="factor" value="<?php echo e($factor); ?>">
                        <input type="hidden" name="id_ant_acad<?php echo e($iterarAntAcad); ?>" id="id_ant_acad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->id); ?>">
                        <input type="hidden" name="puntajeantacad<?php echo e($iterarAntAcad); ?>" id="puntajeantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($factor); ?>">F: <span id="spanF"><?php echo e($factor); ?></span></td>
                    <td style="background-color: #eee;color:#333; width:80px; text-align: right; vertical-align:middle;"><span id="spanpuntajeantacad<?php echo e($iterarAntAcad); ?>"></span><div id="divpuntajeantacad<?php echo e($iterarAntAcad); ?>" class="fValidator-a" ></div></td>
                </tr>
            <?php else: ?>
                <tr style="border-style: solid; border-width: 1px; border-color: #666">
                    <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;"><?php echo e($antAcadMaximo->grupo_nombre); ?><?php echo e($iterarAntAcad+2); ?><br><?php echo $tope; ?></td>
                    <?php
                    ...
                    ?>
                    <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 60%;"><?php echo $descripcion; ?></td>
                    <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 20%">
                        <input type="hidden" name="id_ant_acad<?php echo e($iterarAntAcad); ?>" id="id_ant_acad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->id); ?>">
                        <input type="hidden" name="maxantacad<?php echo e($iterarAntAcad); ?>" id="maxantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->maximo); ?>">
                        <input type="hidden" name="topeantacad<?php echo e($iterarAntAcad); ?>" id="topeantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->tope); ?>">
                        <input type="hidden" name="minantacad<?php echo e($iterarAntAcad); ?>" id="minantacad<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->minimo); ?>">
                        <input type="hidden" name="ant_acad_evaluacion_grupo_id<?php echo e($iterarAntAcad); ?>" id="ant_acad_evaluacion_grupo_id<?php echo e($iterarAntAcad); ?>" value="<?php echo e($antAcadMaximo->evaluacion_grupo_id); ?>"><?php echo $hasta; ?>
                    ...
                    <td style="background-color: #eee;color:#333; width:80px; text-align: right; vertical-align:middle;">
                        <span id="spanpuntajeantacad<?php echo e($iterarAntAcad); ?>">0</span>
                        <div id="divpuntajeantacad<?php echo e($iterarAntAcad); ?>" class="fValidator-a"></div>
                        <input name="valorantacad<?php echo e($iterarAntAcad); ?>" id="valorantacad<?php echo e($iterarAntAcad); ?>" type="hidden" value="">
                    </td>
                </tr>
            <?php endif; ?>
            <?php
        ...
        <?php if($ultimoAntAcadMaximo->grupo_maximo!=0): ?>
            ...
            <tr style="background-color: #eee;color:#333;">
                ...
                <td colspan="3">
                    <div align="right">
                        <strong>Subtotal <?php echo e($ultimoAntAcadMaximo->grupo_nombre); ?> (max. <?php echo e($ultimoAntAcadMaximo->grupo_maximo); ?>)</strong>
                    </div>
                    <input type="hidden"  name="maxgrupoantacad<?php echo e($ultimoAntAcadMaximo->evaluacion_grupo_id); ?>" id="maxgrupoantacad<?php echo e($ultimoAntAcadMaximo->evaluacion_grupo_id); ?>" value="<?php echo e($ultimoAntAcadMaximo->grupo_maximo); ?>">
                </td>
                <td style="text-align:right">
                    <strong><span id="spangrupoAntacad<?php echo e($ultimoAntAcadMaximo->evaluacion_grupo_id); ?>" ></span></strong>
                    <div id="divgrupoAntacad<?php echo e($ultimoAntAcadMaximo->evaluacion_grupo_id); ?>" class="fValidator-a"></div>
                </td>
            </tr>
        <?php endif; ?>
            ...
            <tr style="border-style: solid; border-width: 1px; border-color: #666">
                ...
                <td>
                    <table style="width:100%">
                        <tbody>
                            <tr>
                                <?php $__currentLoopData = $cargoMaximos->chunk(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chunk): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Divide los cargos en grupos de 2 -->
                            <tr>
                                <?php $__currentLoopData = $chunk; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cargoMaximo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <!-- Recorre cada "chunk" de 2 elementos -->
                                <?php
                                ...
                                <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;">
                                    <input name="cargomaximo"
                                           id="cargomaximo<?php echo e($loop->index + $index); ?>"
                                           type="radio"
                                           value="<?php echo e($cargoMaximo->id); ?>-<?php echo e($cargoMaximo->maximo); ?>"
                                           onclick="sumar_total();"
                                           <?php echo e($checked); ?>

                                           DISABLED />

                                    <input name="maxcargo<?php echo e($loop->index + $index); ?>"
                                           id="maxcargo<?php echo e($loop->index + $index); ?>"
                                           type="hidden"
                                           value="<?php echo e($cargoMaximo->maximo); ?>" />

                                    <?php echo e($cargoMaximo->cargo_nombre); ?> (<?php echo e($cargoMaximo->maximo); ?>pt.)
                                </td>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666 ;margin-bottom:5px">
        <tbody><tr style="border-style: solid; border-width: 1px; border-color: #666">
            <td style="background-color: #eee;color:#333; width:80px"><?php echo e($primerOtros->padre_nombre); ?></td>
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666;margin-bottom:5px">
        <tbody>
        <input type="hidden" name="cantotros" id="cantotros" value="<?php echo e($otroMaximos->count()); ?>">
        <tr style="border-style: solid; border-width: 1px; border-color: #666">
        <?php
            $submax = 0;
            $sub = 0;
        ...
        <?php $__currentLoopData = $otroMaximos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $otroMaximo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php if($submax != $otroMaximo->evaluacion_grupo_id): ?>
                ...
                <?php if($loop->index != 0 && $otroMaximos[$loop->index - 1]->grupo_maximo != 0): ?>
                    <tr style="background-color: #eee; color: #333;">
                        ...
                        <td colspan="3">
                            <div align="right">
                                <strong>Subtotal (max. <?php echo e($otroMaximos[$loop->index - 1]->grupo_maximo); ?>)</strong>
                            </div>
                            <input type="hidden"
                                   name="maxgrupootros<?php echo e($otroMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                                   id="maxgrupootros<?php echo e($otroMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                                   value="<?php echo e($otroMaximos[$loop->index - 1]->grupo_maximo); ?>" />
                            <strong>
                                <div id="divgrupootros<?php echo e($otroMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div>
                            </strong>
                        </td>
                        <td style="text-align:right"><strong><span id="spangrupoOtro<?php echo e($otroMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupoOtro<?php echo e($otroMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
                    </tr>
                <?php endif; ?>
            ...
            <?php if($sub != $otroMaximo->evaluacion_subgrupo_id && $otroMaximo->evaluacion_subgrupo_id): ?>
                ...
                ?>
                <tr>
                    <td style="background-color: #eee; color: #333; width: 80px; vertical-align: middle;"><?php echo e($otroMaximo->padre_nombre); ?><?php echo e($j); ?></td>
                    <td style="background-color: #eee; color: #333;" colspan="4">
                        <div align="left">
                            <strong><?php echo e($otroMaximo->subgrupo_nombre); ?></strong>
                        </div>
                    </td>
                </tr>
            ...
            <?php if($otroMaximo->evaluacion_subgrupo_id): ?>
                <td style="background-color: #eee;color:#333; width:80px"><?php echo $tope; ?></td>
            <?php else: ?>
                <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;"><?php echo e($otroMaximo->padre_nombre); ?><?php echo e($j); ?><br><?php echo $tope; ?></td>
            <?php endif; ?>
            <td style="width:450px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 60%;"><?php echo $descripcion; ?></td>
            <td style="width:120px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 20%;">
                <input type="hidden" name="id_otros<?php echo e($loop->index); ?>" id="id_otros<?php echo e($loop->index); ?>" value="<?php echo e($otroMaximo->id); ?>">
                <input type="hidden"  name="maxotros<?php echo e($loop->index); ?>" id="maxotros<?php echo e($loop->index); ?>" value="<?php echo e($otroMaximo->maximo); ?>">
                <input type="hidden"  name="topeotros<?php echo e($loop->index); ?>" id="topeotros<?php echo e($loop->index); ?>" value="<?php echo e($otroMaximo->tope); ?>">
                <input type="hidden"  name="minotros<?php echo e($loop->index); ?>" id="minotros<?php echo e($loop->index); ?>" value="<?php echo e($otroMaximo->minimo); ?>">
                <input type="hidden"  name="otro_evaluacion_grupo_id<?php echo e($loop->index); ?>" id="otro_evaluacion_grupo_id<?php echo e($loop->index); ?>" value="<?php echo e($otroMaximo->evaluacion_grupo_id); ?>"><?php echo $hasta; ?>

            </td>
            <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;"><?php echo $input; ?></td>
            <td style="background-color: #eee;color:#333; width:80px; text-align: right; vertical-align:middle;">
                <span id="spanpuntajeotros<?php echo e($loop->index); ?>" ></span>
                <div id="divpuntajeotros<?php echo e($loop->index); ?>" class="fValidator-a"></div>
                <input name="valorotros<?php echo e($loop->index); ?>" id="valorotros<?php echo e($loop->index); ?>" type="hidden" value=""/>
            </td>
        </tr>
        ...
        <?php if($ultimoOtroMaximo->grupo_maximo != 0): ?>
            ...
            <td></td>
            <td colspan="3">
                <div align="right"><strong>Subtotal (max. <?php echo e($ultimoOtroMaximo->grupo_maximo); ?>)</strong></div>
                <input type="hidden"  name="maxgrupootros<?php echo e($ultimoOtroMaximo->evaluacion_grupo_id); ?>" id="maxgrupootros<?php echo e($ultimoOtroMaximo->evaluacion_grupo_id); ?>" value="<?php echo e($ultimoOtroMaximo->grupo_maximo); ?>">
            </td>
            <td style="text-align:right"><strong><span id="spangrupootros<?php echo e($ultimoOtroMaximo->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupootros<?php echo e($ultimoOtroMaximo->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
            </tr>
        <?php endif; ?>
        <?php if($ultimoOtroMaximo->padre_id): ?>
            ...
            <td colspan="4">
                <div align="right">
                    <strong>Subtotal <?php echo e($ultimoOtroMaximo->padre_nombre); ?> (max. <?php echo e($ultimoOtroMaximo->padre_maximo); ?>)</strong>
                </div>
                <input type="hidden"  name="maxgrupootros" id="maxgrupootros" value="<?php echo e($ultimoOtroMaximo->padre_maximo); ?>"></td><td style="text-align:right">
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666 ;margin-bottom:5px">
        <tbody>
        <tr style="border-style: solid; border-width: 1px; border-color: #666">
            <td style="background-color: #eee;color:#333; width:80px"><?php echo e($primerProduccions->padre_nombre); ?></td>
            <td style="background-color: #eee;color:#333;" colspan="5"><div align="center"><strong>FORMACI&Oacute;N DE RR.HH. Y PRODUCCI&Oacute;N CIENT&Iacute;FICA EN LOS ULTIMOS 5 A&Ntilde;OS  (<?php echo e($periodoActual-4); ?>, <?php echo e($periodoActual-3); ?>, <?php echo e($periodoActual-2); ?>, <?php echo e($periodoActual-1); ?>, <?php echo e($periodoActual); ?>)</strong></div></td>
        </tr>
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666;margin-bottom:5px">
        <tbody>
        <input type="hidden" name="cantproduccions" id="cantproduccions" value="<?php echo e($produccionMaximos->count()); ?>">
        <tr style="border-style: solid; border-width: 1px; border-color: #666">
    <?php
        $submax = 0;
        $sub = 0;
    ...
    <?php $__currentLoopData = $produccionMaximos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $produccionMaximo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php if($submax != $produccionMaximo->evaluacion_grupo_id): ?>
            ...
            <?php if($loop->index != 0 && $produccionMaximos[$loop->index - 1]->grupo_maximo != 0): ?>
                <tr style="background-color: #eee; color: #333;">
                    ...
                    <td colspan="3">
                        <div align="right">
                            <strong>Subtotal (max. <?php echo e($produccionMaximos[$loop->index - 1]->grupo_maximo); ?>)</strong>
                        </div>
                        <input type="hidden"
                               name="maxgrupoproduccion<?php echo e($produccionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               id="maxgrupoproduccion<?php echo e($produccionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               value="<?php echo e($produccionMaximos[$loop->index - 1]->grupo_maximo); ?>" />
                        <strong>
                            <div id="divgrupoproduccions<?php echo e($produccionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div>
                        </strong>
                    </td>
                    <td style="text-align:right"><strong><span id="spangrupoProduccion<?php echo e($produccionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupoProduccion<?php echo e($produccionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
                </tr>
            <?php endif; ?>
        ...
        <?php if($sub != $produccionMaximo->evaluacion_subgrupo_id && $produccionMaximo->evaluacion_subgrupo_id): ?>
            ...
            ?>
            <tr>
                <td style="background-color: #eee; color: #333; width: 80px; vertical-align: middle;"><?php echo e($produccionMaximo->padre_nombre); ?><?php echo e($j); ?></td>
                <td style="background-color: #eee; color: #333;" colspan="4">
                    <div align="left">
                        <strong><?php echo e($produccionMaximo->subgrupo_nombre); ?></strong>
                    </div>
                </td>
            </tr>
        ...
        <?php if($produccionMaximo->evaluacion_subgrupo_id): ?>
            <td style="background-color: #eee;color:#333; width:80px"><?php echo $tope; ?></td>
        <?php else: ?>
            <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;"><?php echo e($produccionMaximo->padre_nombre); ?><?php echo e($j); ?><br><?php echo $tope; ?></td>
        <?php endif; ?>
        <td style="width:450px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 60%;"><?php echo $descripcion; ?></td>
        <td style="width:120px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 20%;">
            <input type="hidden"  name="id_produccion<?php echo e($loop->index); ?>" id="id_produccion<?php echo e($loop->index); ?>" value="<?php echo e($produccionMaximo->id); ?>">
            <input type="hidden"  name="maxproduccion<?php echo e($loop->index); ?>" id="maxproduccion<?php echo e($loop->index); ?>" value="<?php echo e($produccionMaximo->maximo); ?>">
            <input type="hidden"  name="topeproduccion<?php echo e($loop->index); ?>" id="topeproduccion<?php echo e($loop->index); ?>" value="<?php echo e($produccionMaximo->tope); ?>">
            <input type="hidden"  name="minproduccion<?php echo e($loop->index); ?>" id="minproduccion<?php echo e($loop->index); ?>" value="<?php echo e($produccionMaximo->minimo); ?>">
            <input type="hidden"  name="produccion_evaluacion_grupo_id<?php echo e($loop->index); ?>" id="produccion_evaluacion_grupo_id<?php echo e($loop->index); ?>" value="<?php echo e($produccionMaximo->evaluacion_grupo_id); ?>"><?php echo $hasta; ?>
    ...
    <?php if($ultimoProduccionMaximo->grupo_maximo != 0): ?>
        ...
        <td></td>
        <td colspan="3">
            <div align="right"><strong>Subtotal (max. <?php echo e($ultimoProduccionMaximo->grupo_maximo); ?>)</strong></div>
            <input type="hidden"  name="maxgrupoproduccion<?php echo e($ultimoProduccionMaximo->evaluacion_grupo_id); ?>" id="maxgrupoproduccion<?php echo e($ultimoProduccionMaximo->evaluacion_grupo_id); ?>" value="<?php echo e($ultimoProduccionMaximo->grupo_maximo); ?>">
        </td>
        <td style="text-align:right"><strong><span id="spangrupoproduccion<?php echo e($ultimoProduccionMaximo->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupoproduccion<?php echo e($ultimoProduccionMaximo->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
        </tr>
    <?php endif; ?>
    <?php if($ultimoProduccionMaximo->padre_id): ?>
        ...
        <td colspan="4">
            <div align="right">
                <strong>Subtotal <?php echo e($ultimoProduccionMaximo->padre_nombre); ?> (max. <?php echo e($ultimoProduccionMaximo->padre_maximo); ?>)</strong>
            </div>
            <input type="hidden"  name="maxgrupoproduccion" id="maxgrupoproduccion" value="<?php echo e($ultimoProduccionMaximo->padre_maximo); ?>"></td><td style="text-align:right">
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666;margin-bottom:5px">
        <tbody>
        <input type="hidden" name="cantanteriors" id="cantanteriors" value="<?php echo e($anteriorMaximos->count()); ?>">
        <tr style="border-style: solid; border-width: 1px; border-color: #666">
            <?php
                $submax = 0;
                $sub = 0;
        ...
        <?php if($submax != $anteriorMaximo->evaluacion_grupo_id): ?>
            ...
            <?php if($loop->index != 0 && $anteriorMaximos[$loop->index - 1]->grupo_maximo != 0): ?>
                <tr style="background-color: #eee; color: #333;">
                    ...
                    <td colspan="3">
                        <div align="right">
                            <strong>Subtotal (max. <?php echo e($anteriorMaximos[$loop->index - 1]->grupo_maximo); ?>)</strong>
                        </div>
                        <input type="hidden"
                               name="maxgrupoanterior<?php echo e($anteriorMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               id="maxgrupoanterior<?php echo e($anteriorMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               value="<?php echo e($anteriorMaximos[$loop->index - 1]->grupo_maximo); ?>" />
                        <strong>
                            <div id="divgrupoanterior<?php echo e($anteriorMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div>
                        </strong>
                    </td>
                    <td style="text-align:right"><strong><span id="spangrupoAnterior<?php echo e($anteriorMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupoAnterior<?php echo e($anteriorMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
                </tr>
            <?php endif; ?>
        ...
        <?php if($sub != $anteriorMaximo->evaluacion_subgrupo_id && $anteriorMaximo->evaluacion_subgrupo_id): ?>
            ...
            ?>
            <tr>
                <td style="background-color: #eee; color: #333; width: 80px; vertical-align: middle;">E<?php echo e($j); ?></td>
                <td style="background-color: #eee; color: #333;" colspan="4">
                    <div align="left">
                        <strong><?php echo e($anteriorMaximo->subgrupo_nombre); ?></strong>
                    </div>
                </td>
            </tr>
        ...
        <?php if($anteriorMaximo->evaluacion_subgrupo_id): ?>
            <td style="background-color: #eee;color:#333; width:80px"><?php echo $tope; ?></td>
        <?php else: ?>
            <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;">E<?php echo e($j); ?><br><?php echo $tope; ?></td>
        <?php endif; ?>
        <td style="width:450px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 60%;"><?php echo $descripcion; ?></td>
        <td style="width:120px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 20%;">
            <input type="hidden"  name="id_anterior<?php echo e($loop->index); ?>" id="id_anterior<?php echo e($loop->index); ?>" value="<?php echo e($anteriorMaximo->id); ?>">
            <input type="hidden"  name="maxanterior<?php echo e($loop->index); ?>" id="maxanterior<?php echo e($loop->index); ?>" value="<?php echo e($anteriorMaximo->maximo); ?>">
            <input type="hidden"  name="topeanterior<?php echo e($loop->index); ?>" id="topeanterior<?php echo e($loop->index); ?>" value="<?php echo e($anteriorMaximo->tope); ?>">
            <input type="hidden"  name="minanterior<?php echo e($loop->index); ?>" id="minanterior<?php echo e($loop->index); ?>" value="<?php echo e($anteriorMaximo->minimo); ?>">
            <input type="hidden"  name="anterior_evaluacion_grupo_id<?php echo e($loop->index); ?>" id="anterior_evaluacion_grupo_id<?php echo e($loop->index); ?>" value="<?php echo e($anteriorMaximo->evaluacion_grupo_id); ?>"><?php echo $hasta; ?>

        </td>
        <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;"><?php echo $input; ?></td>
        <td style="background-color: #eee;color:#333; width:80px; text-align: right; vertical-align:middle;">
            <span id="spanpuntajeanterior<?php echo e($loop->index); ?>" ></span>
            <div id="divpuntajeanterior<?php echo e($loop->index); ?>" class="fValidator-a"></div>
            <input name="valoranterior<?php echo e($loop->index); ?>" id="valoranterior<?php echo e($loop->index); ?>" type="hidden" value=""/>
        </td></tr>
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666 ;margin-bottom:5px">
        <tbody><tr style="border-style: solid; border-width: 1px; border-color: #666">
            <td style="background-color: #eee;color:#333; width:80px"><?php echo e($primerJustificacions->grupo_nombre); ?></td>
    ...
    <table style="width:100%; border-style: solid; border-width: 1px;  border-color: #666;margin-bottom:5px">
        <tbody>
        <input type="hidden" name="cantjustificacions" id="cantjustificacions" value="<?php echo e($justificacionMaximos->count()); ?>">
        <tr style="border-style: solid; border-width: 1px; border-color: #666">
            <?php
                $submax = 0;
                $sub = 0;
        ...
        <?php if($submax != $justificacionMaximo->evaluacion_grupo_id): ?>
            ...
            <?php if($loop->index != 0 && $justificacionMaximos[$loop->index - 1]->grupo_maximo != 0): ?>
                <tr style="background-color: #eee; color: #333;">
                    ...
                    <td colspan="3">
                        <div align="right">
                            <strong>Subtotal (max. <?php echo e($justificacionMaximos[$loop->index - 1]->grupo_maximo); ?>)</strong>
                        </div>
                        <input type="hidden"
                               name="maxgrupojustificacions<?php echo e($justificacionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               id="maxgrupojustificacions<?php echo e($justificacionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>"
                               value="<?php echo e($justificacionMaximos[$loop->index - 1]->grupo_maximo); ?>" />
                        <strong>
                            <div id="divgrupojustificacions<?php echo e($justificacionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div>
                        </strong>
                    </td>
                    <td style="text-align:right"><strong><span id="spangrupoJustificacion<?php echo e($justificacionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupoJustificacion<?php echo e($justificacionMaximos[$loop->index - 1]->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
                </tr>
            <?php endif; ?>
        ...
        <?php if($sub != $justificacionMaximo->evaluacion_subgrupo_id && $justificacionMaximo->evaluacion_subgrupo_id): ?>
            ...
            ?>
            <tr>
                <td style="background-color: #eee; color: #333; width: 80px; vertical-align: middle;"><?php echo e($justificacionMaximo->grupo_nombre); ?><?php echo e($j); ?></td>
                <td style="background-color: #eee; color: #333;" colspan="4">
                    <div align="left">
                        <strong><?php echo e($justificacionMaximo->subgrupo_nombre); ?></strong>
                    </div>
                </td>
            </tr>
        ...
        <?php if($justificacionMaximo->evaluacion_subgrupo_id): ?>
            <td style="background-color: #eee;color:#333; width:80px"><?php echo $tope; ?></td>
        <?php else: ?>
            <td style="background-color: #eee;color:#333; width:80px; vertical-align:middle;"><?php echo e($justificacionMaximo->grupo_nombre); ?><?php echo e($j); ?><br><?php echo $tope; ?></td>
        <?php endif; ?>
        <td style="width:450px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 60%;"><?php echo $descripcion; ?></td>
        <td style="width:120px;background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;width: 20%;">
            <input type="hidden"  name="id_justificacions<?php echo e($loop->index); ?>" id="id_justificacions<?php echo e($loop->index); ?>" value="<?php echo e($justificacionMaximo->id); ?>">
            <input type="hidden"  name="maxjustificacions<?php echo e($loop->index); ?>" id="maxjustificacions<?php echo e($loop->index); ?>" value="<?php echo e($justificacionMaximo->maximo); ?>">
            <input type="hidden"  name="topejustificacions<?php echo e($loop->index); ?>" id="topejustificacions<?php echo e($loop->index); ?>" value="<?php echo e($justificacionMaximo->tope); ?>">
            <input type="hidden"  name="minjustificacions<?php echo e($loop->index); ?>" id="minjustificacions<?php echo e($loop->index); ?>" value="<?php echo e($justificacionMaximo->minimo); ?>">
            <input type="hidden"  name="justificacion_evaluacion_grupo_id<?php echo e($loop->index); ?>" id="justificacion_evaluacion_grupo_id<?php echo e($loop->index); ?>" value="<?php echo e($justificacionMaximo->evaluacion_grupo_id); ?>"><?php echo $hasta; ?>

        </td>
        <td style="background-color: #fff; border-width: 1px; border-color: #eee;text-align: left;"><?php echo $input; ?></td>
        <td style="background-color: #eee;color:#333; width:80px; text-align: right; vertical-align:middle;">
            <span id="spanpuntajejustificacions<?php echo e($loop->index); ?>" ></span>
            <div id="divpuntajejustificacions<?php echo e($loop->index); ?>" class="fValidator-a"></div>
            <input name="valorjustificacions<?php echo e($loop->index); ?>" id="valorjustificacions<?php echo e($loop->index); ?>" type="hidden" value=""/>
        </td>
        </tr>
        ...
        <?php
            ...
            //dd($ultimoAntAcadMaximo);
        ?>
        <?php if($ultimoJustificacionMaximo->grupo_maximo != 0): ?>
            <tr style="background-color: #eee;color:#333;"">
            <td></td>
            <td colspan="3">
                <div align="right"><strong>Subtotal (max. <?php echo e($ultimoJustificacionMaximo->grupo_maximo); ?>)</strong></div>
                <input type="hidden"  name="maxgrupojustificacions<?php echo e($ultimoJustificacionMaximo->evaluacion_grupo_id); ?>" id="maxgrupojustificacions<?php echo e($ultimoJustificacionMaximo->evaluacion_grupo_id); ?>" value="<?php echo e($ultimoJustificacionMaximo->grupo_maximo); ?>">
            </td>
            <td style="text-align:right"><strong><span id="spangrupojustificacions<?php echo e($ultimoJustificacionMaximo->evaluacion_grupo_id); ?>" ></span></strong><div id="divgrupojustificacions<?php echo e($ultimoJustificacionMaximo->evaluacion_grupo_id); ?>" class="fValidator-a"></div></td>
            </tr>
        <?php endif; ?>
        <?php if($ultimoJustificacionMaximo->padre_id): ?>
            <tr style="background-color: #eee;color:#333;"">
            <td colspan="4">
                <div align="right">
                    <strong>Subtotal <?php echo e($ultimoJustificacionMaximo->grupo_nombre); ?> (max. <?php echo e($ultimoJustificacionMaximo->padre_maximo); ?>)</strong>
                </div>
                <input type="hidden"  name="maxgrupojustificacions" id="maxgrupojustificacions" value="<?php echo e($ultimoJustificacionMaximo->padre_maximo); ?>"></td><td style="text-align:right">
                ...
                <table style="width:100%">
                    <tbody><tr>
                        <td><div align="right">
                                ...
                                <strong> Total (max. <span><?php echo e($planilla->maximo); ?></span> )</strong></div></td>
                    </tr>
                    </tbody></table>                        </td>
            <td style="background-color: #eee;color:#333; width:80px"><div align="right"><strong><span id="spanTotal">
                            0</span></strong></div>

            <?php echo e(Form::hidden('puntaje',0,['id' => 'puntaje'])); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
            ...
            <?php echo e(Form::textarea('observaciones', $evaluacion->observaciones, ['class' => 'form-control'])); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/joven_evaluacions/evaluar.blade.php ENDPATH**/ ?>