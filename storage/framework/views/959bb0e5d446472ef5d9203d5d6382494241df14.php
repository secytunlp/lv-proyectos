                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header with-border">
                            ...
                            <?php if($solicitud_sicadi): ?><a class='pull-right btn btn-success' href="<?php echo e(route('solicitud_sicadi_estados.create', ['solicitud_sicadi_id' => $solicitud_sicadi->id])); ?>">Cambiar</a><?php endif; ?>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo e(route('solicitud_sicadi_estados.dataTable')); ?>",
                    "type": "POST",
                    "data": function (d) {
                        d._token = '<?php echo e(csrf_token()); ?>'; // Agrega el token CSRF si estás usando Laravel
                        d.solicitud_sicadi_id = '<?php echo e($solicitud_sicadi ? $solicitud_sicadi->id : ''); ?>'; // Enviar el ID del solicitud_sicadi como filtro
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sicadi/resources/views/solicitud_sicadi_estados/index.blade.php ENDPATH**/ ?>